var items = {
    ...
    "block.minecraft.banner.border.gray": "Pākuʻi hina",
    "block.minecraft.banner.border.green": "Laina ʻōmaʻomaʻo",
    "block.minecraft.banner.border.light_blue": "Pākuʻi Blue Light",
    "block.minecraft.banner.border.light_gray": "Pākuʻi Hinahina Māmā",
    "block.minecraft.banner.border.lime": "Lime Bordure",
    "block.minecraft.banner.border.magenta": "Magenta Bordure",
    "block.minecraft.banner.border.orange": "Bordure ʻalani",
    ...
    "block.minecraft.banner.border.white": "Pākuʻi keʻokeʻo",
    "block.minecraft.banner.border.yellow": "Pālani melemele",
    ...
    "block.minecraft.banner.circle.black": "ʻEleʻele Roundel",
    ...
    "block.minecraft.banner.circle.gray": "ʻO Gray Roundel",
    "block.minecraft.banner.circle.green": "Green Roundel",
    "block.minecraft.banner.circle.light_blue": "ʻO Blue Roundel",
    "block.minecraft.banner.circle.light_gray": "ʻO Roundel hina hina",
    "block.minecraft.banner.circle.lime": "Lime Roundel",
    "block.minecraft.banner.circle.magenta": "Magenta Roundel",
    "block.minecraft.banner.circle.orange": "ʻO Orange Roundel",
    "block.minecraft.banner.circle.pink": "Pink Roundel",
    "block.minecraft.banner.circle.purple": "Puni Roundel",
    "block.minecraft.banner.circle.red": "Red Rounde",
    "block.minecraft.banner.circle.white": "White Roundel",
    "block.minecraft.banner.circle.yellow": "Yellow Roundel",
    "block.minecraft.banner.creeper.black": "Uku Crepe ʻeleʻele",
    ...
    "block.minecraft.banner.creeper.green": "Kauoha Creeper Green",
    ...
    "block.minecraft.banner.creeper.red": "Uku Creeper ʻUla",
    "block.minecraft.banner.creeper.white": "Kauoha Creeper White",
    "block.minecraft.banner.creeper.yellow": "Kauoha Creeper Yellow",
    "block.minecraft.banner.cross.white": "Paakai Paakai",
    "block.minecraft.banner.curly_border.black": "Pākuʻi ʻia ka Black Bordure",
    "block.minecraft.banner.curly_border.blue": "Indented Blue",
    "block.minecraft.banner.curly_border.brown": "Indentina Brown",
    "block.minecraft.banner.curly_border.cyan": "Kālena ʻia ʻo Cyan Bordure",
    "block.minecraft.banner.curly_border.gray": "Hinahina Hinahina Hinahina",
    "block.minecraft.banner.curly_border.green": "Pākuʻi ʻia ka Green Bordure",
    "block.minecraft.banner.curly_border.light_blue": "Pākuʻi ʻia ka Blue Blue Bordure",
    "block.minecraft.banner.curly_border.light_gray": "Pākuʻi ʻia ka Hina Grey Light",
    "block.minecraft.banner.curly_border.lime": "Pākuʻi ʻia ka Lime Bordure",
    "block.minecraft.banner.curly_border.pink": "Pākuʻi ʻia ʻo Pink Bordure",
    "block.minecraft.banner.curly_border.purple": "Indent Bordure Indent",
    "block.minecraft.banner.curly_border.red": "Indented Ulaula",
    "block.minecraft.banner.curly_border.yellow": "Pākuʻi ʻia ka Yellow Yellow",
    "block.minecraft.banner.diagonal_up_left.blue": "ʻO Blue Per Bend i huli ʻia",
    "block.minecraft.banner.diagonal_up_left.brown": "ʻO Brown Per Bend i hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_left.cyan": "Ua hoʻohuli ʻia ʻo Cyan Per Bend",
    "block.minecraft.banner.diagonal_up_left.gray": "Hinahina Per Bend Huli ʻia",
    "block.minecraft.banner.diagonal_up_left.light_blue": "ʻO Blue Blue Per Bend i huli ʻia",
    "block.minecraft.banner.diagonal_up_left.light_gray": "Hinahina Mālamama Per Bend Huli ʻia",
    "block.minecraft.banner.diagonal_up_left.lime": "Lime Per Bend huli aʻe",
    "block.minecraft.banner.diagonal_up_left.magenta": "Hoʻokahuli ʻo Magenta Per Bend",
    "block.minecraft.banner.diagonal_up_left.orange": "ʻOrangelani Per Bend i hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_left.pink": "ʻO Pink Per Bend i huli ʻia",
    "block.minecraft.banner.diagonal_up_left.purple": "Poni Per Bend Huli ʻia",
    "block.minecraft.banner.diagonal_up_left.white": "Keʻokeʻo Per Bend i huli ʻia",
    "block.minecraft.banner.diagonal_up_left.yellow": "Lepo Per Bend i huli ʻia",
    "block.minecraft.banner.diagonal_up_right.black": "ʻO Black Per Bend Sinister i hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_right.blue": "ʻO Blue Per Bend Sinister i hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_right.brown": "ʻO Brown Per Bend Sinister i hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_right.cyan": "Ua hoʻohuli ʻia ʻo Cyan Per Bend Sinister",
    "block.minecraft.banner.diagonal_up_right.gray": "Hinahina Per Bend Sinister hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_right.green": "ʻO Green Per Bend Sinister i hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_right.light_blue": "ʻO Blue Blue Per Bend Sinister i huli ʻia",
    "block.minecraft.banner.diagonal_up_right.light_gray": "Hinahina Māmā Per Bend Sinister hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_right.lime": "Lime Per Bend Sinister hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_right.magenta": "Magenta Per Bend Sinister hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_right.orange": "ʻIliuli ʻo Orange Per Bend Sinister",
    "block.minecraft.banner.diagonal_up_right.pink": "ʻO Pink Per Bend Sinister i hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_right.purple": "Poni Per Bend Sinister hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_right.red": "Ua huli ʻo Red Per Bend Sinister i hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_right.white": "ʻO White Per Bend Sinister i hoʻohuli ʻia",
    "block.minecraft.banner.diagonal_up_right.yellow": "Huli ʻo Yellow Per Bend Sinister i hoʻohuli ʻia",
    ...
    "block.minecraft.banner.half_horizontal_bottom.black": "Huli ʻEliuli Per Fess",
    "block.minecraft.banner.half_horizontal_bottom.blue": "ʻO Blue Per Fess i huli ʻia",
    "block.minecraft.banner.half_horizontal_bottom.brown": "ʻO Brown Per Fess huli ʻia",
    "block.minecraft.banner.half_horizontal_bottom.cyan": "Ua hoʻohuli ʻia ʻo Cyan Per Fess",
    "block.minecraft.banner.half_horizontal_bottom.gray": "Hinahina Per Fess Huli ʻia",
    "block.minecraft.banner.half_horizontal_bottom.green": "ʻO Green Per Fess i huli ʻia",
    "block.minecraft.banner.half_horizontal_bottom.light_blue": "ʻAuliuli Paha Per Fess huli ʻia",
    "block.minecraft.banner.half_horizontal_bottom.light_gray": "Hinahina Māmā Per Fess Huli ʻia",
    "block.minecraft.banner.half_horizontal_bottom.lime": "Lime Per Fess Huli ʻia",
    "block.minecraft.banner.half_horizontal_bottom.magenta": "Hoʻokahuli ʻo Magenta Per Fess",
    "block.minecraft.banner.half_horizontal_bottom.orange": "ʻIliuli ʻo Per Peress Fvers",
    "block.minecraft.banner.half_horizontal_bottom.pink": "ʻO Pink Per Fess i huli ʻia",
    "block.minecraft.banner.half_horizontal_bottom.purple": "Poni Per Fess huli ʻia",
    "block.minecraft.banner.half_horizontal_bottom.red": "Huli Ke ʻulaʻula per Fess",
    "block.minecraft.banner.half_horizontal_bottom.white": "Keʻokeʻo Per Fess Huli ʻia",
    "block.minecraft.banner.half_horizontal_bottom.yellow": "Huli ʻia ʻo Yellow Per Fess",
    "block.minecraft.banner.half_vertical_right.gray": "Hinahina Per Pale huli ʻia",
    "block.minecraft.banner.half_vertical_right.light_blue": "ʻO Blue Blue Per Pale Hoʻohuli",
    "block.minecraft.banner.half_vertical_right.light_gray": "Hinahina Mālamama Per Pale Huli",
    "block.minecraft.banner.half_vertical_right.lime": "Lime Per Pale huli ʻia",
    "block.minecraft.banner.half_vertical_right.magenta": "Hoʻololi ʻo Magenta Per Pale",
    "block.minecraft.banner.half_vertical_right.orange": "ʻPerlani Per Pale huli ʻia",
    "block.minecraft.banner.half_vertical_right.pink": "ʻO Pink Per Pale Hoʻohuli",
    "block.minecraft.banner.half_vertical_right.white": "Keʻokeʻo Per Pale huli ʻia",
    "block.minecraft.banner.half_vertical_right.yellow": "Lepo Per Pale Huli",
    ...
    "block.minecraft.banner.rhombus.black": "Lozenge ʻeleʻele",
    "block.minecraft.banner.rhombus.blue": "Lozenge polū",
    "block.minecraft.banner.rhombus.brown": "ʻO Lozenge Brown",
    "block.minecraft.banner.rhombus.green": "Lozenge ʻōmaʻomaʻo",
    "block.minecraft.banner.rhombus.red": "Lozenge ʻulaʻula",
    ...
    "block.minecraft.banner.square_bottom_left.black": "ʻO Black Base Dexter Canton",
    "block.minecraft.banner.square_bottom_left.blue": "Blue Base Dexter Canton",
    "block.minecraft.banner.square_bottom_left.brown": "ʻO Brown Base Dexter Canton",
    "block.minecraft.banner.square_bottom_left.cyan": "ʻO Cyan Base Dexter Canton",
    "block.minecraft.banner.square_bottom_left.gray": "ʻO Gray Base Dexter Canton",
    "block.minecraft.banner.square_bottom_left.green": "ʻO Green Base Dexter Canton",
    "block.minecraft.banner.square_bottom_left.light_blue": "ʻO Light Blue Base Dexter Canton",
    "block.minecraft.banner.square_bottom_left.light_gray": "ʻO Base Grey Base Dexter Canton",
    "block.minecraft.banner.square_bottom_left.lime": "ʻO Lime Base Dexter Canton",
    "block.minecraft.banner.square_bottom_left.magenta": "ʻO Magenta Base Dexter Canton",
    "block.minecraft.banner.square_bottom_left.orange": "ʻO Orange Base Dexter Canton",
    "block.minecraft.banner.square_bottom_left.pink": "Pink Base Dexter Canton",
    "block.minecraft.banner.square_bottom_left.purple": "Lila Pepe Dexter Canton",
    "block.minecraft.banner.square_bottom_left.red": "ʻO Red Base Dexter Canton",
    ...
    "block.minecraft.banner.square_bottom_right.black": "ʻO Base Base Sinister Canton",
    "block.minecraft.banner.square_bottom_right.blue": "Blue Base Sinister Canton",
    "block.minecraft.banner.square_bottom_right.brown": "ʻO Brown Base Sinister Canton",
    "block.minecraft.banner.square_bottom_right.cyan": "ʻO Cyan Base Sinister Canton",
    "block.minecraft.banner.square_bottom_right.gray": "ʻO Gray Base Sinister Canton",
    "block.minecraft.banner.square_bottom_right.green": "ʻO Green Base Sinister Canton",
    "block.minecraft.banner.square_bottom_right.light_blue": "ʻOihana Blue Blue Sinister Canton",
    "block.minecraft.banner.square_bottom_right.light_gray": "ʻO Base Grey Base Sinister Canton",
    "block.minecraft.banner.square_bottom_right.lime": "ʻO Lime Base Sinister Canton",
    "block.minecraft.banner.square_bottom_right.magenta": "ʻO Magenta Base Sinister Canton",
    "block.minecraft.banner.square_bottom_right.orange": "ʻO Orange Base Sinister Canton",
    "block.minecraft.banner.square_bottom_right.pink": "Pink Base Sinister Canton",
    "block.minecraft.banner.square_bottom_right.purple": "Pepeiao Sinist Canton",
    "block.minecraft.banner.square_bottom_right.red": "ʻO Base Base Sinister Canton",
    "block.minecraft.banner.square_bottom_right.white": "Kanalehua Sinister Canton",
    "block.minecraft.banner.square_bottom_right.yellow": "O' Yellow Base Sinister Canton",
    "block.minecraft.banner.square_top_left.black": "Ke Aliʻi ʻEleʻele Dexter Canton",
    "block.minecraft.banner.square_top_left.blue": "ʻO Blue Chief Dexter Canton",
    "block.minecraft.banner.square_top_left.brown": "ʻO Brown Aliʻi Dexter Canton",
    "block.minecraft.banner.square_top_left.cyan": "ʻO Cyan Chief Dexter Canton",
    "block.minecraft.banner.square_top_left.gray": "ʻO Gray Aliʻi Dexter Canton",
    "block.minecraft.banner.square_top_left.green": "ʻO Green Chief Dexter Canton",
    "block.minecraft.banner.square_top_left.light_blue": "ʻO Blue Chief Light Dexter Canton",
    "block.minecraft.banner.square_top_left.light_gray": "Ke Aliʻi ʻ Grayhinahina Light Dexter Canton",
    "block.minecraft.banner.square_top_left.lime": "ʻO Lime Chief Dexter Canton",
    "block.minecraft.banner.square_top_left.magenta": "ʻO Magenta Aliʻi Dexter Canton",
    "block.minecraft.banner.square_top_left.orange": "ʻO Orange Aliʻi Dexter Canton",
    "block.minecraft.banner.square_top_left.pink": "ʻO Pink Chief Dexter Canton",
    "block.minecraft.banner.square_top_left.purple": "Pepeiao Dexter Canton",
    "block.minecraft.banner.square_top_left.red": "ʻO Red Chief Dexter Canton",
    "block.minecraft.banner.square_top_left.white": "Ke Aliʻi Keʻokeʻo Dexter Canton",
    "block.minecraft.banner.square_top_left.yellow": "ʻO Yellow Chief Dexter Canton",
    "block.minecraft.banner.square_top_right.black": "Ke Aliʻi ʻEleʻele Sinister Canton",
    ...
    "block.minecraft.banner.square_top_right.red": "Ke Aliʻi Ulaula Sinister Canton",
    ...
    "block.minecraft.banner.stripe_center.brown": "Pale Brown",
    ...
    "block.minecraft.banner.stripe_downright.black": "Pua ʻEleʻele",
    "block.minecraft.banner.stripe_downright.blue": "Pālua Kahuli",
    "block.minecraft.banner.stripe_downright.brown": "ʻO Bend Bend",
    "block.minecraft.banner.stripe_downright.cyan": "Cyan Bend",
    "block.minecraft.banner.stripe_downright.gray": "Pālua hina",
    "block.minecraft.banner.stripe_downright.green": "Pālena ʻōmaʻomaʻo",
    "block.minecraft.banner.stripe_downright.light_blue": "Pua Pulu Uila",
    "block.minecraft.banner.stripe_downright.light_gray": "Pālua Hinahina Māmā",
    "block.minecraft.banner.stripe_downright.lime": "Kulou Lime",
    ...
    "block.minecraft.banner.stripe_downright.purple": "Pua Lila",
    "block.minecraft.banner.stripe_downright.red": "Kulou ʻulaʻula",
    "block.minecraft.banner.stripe_downright.white": "Pālua Keʻokeʻo",
    "block.minecraft.banner.stripe_downright.yellow": "Pua melemele",
    ...
    "block.minecraft.banner.stripe_middle.gray": "ʻO Fess Grey",
    "block.minecraft.banner.stripe_middle.green": "Uku ʻōmaʻomaʻo",
    "block.minecraft.banner.stripe_middle.light_blue": "Pahu ʻAilana Mālamalama",
    "block.minecraft.banner.stripe_middle.light_gray": "Fess Kukui Māmā",
    "block.minecraft.banner.stripe_middle.lime": "ʻO Lime Fess",
    "block.minecraft.banner.stripe_middle.magenta": "ʻO Magenta Fess",
    ...
    "block.minecraft.banner.stripe_middle.white": "Lehi Keʻokeʻo",
    "block.minecraft.banner.stripe_middle.yellow": "ʻAha Mele melemele",
    ...
    "block.minecraft.banner.triangle_bottom.black": "Chevron ʻEleʻele",
    "block.minecraft.banner.triangle_bottom.blue": "Blue Chevron",
    "block.minecraft.banner.triangle_bottom.brown": "ʻO Brown Chevron",
    "block.minecraft.banner.triangle_bottom.cyan": "ʻO Cyan Chevron",
    "block.minecraft.banner.triangle_bottom.gray": "ʻO Gray Chevron",
    "block.minecraft.banner.triangle_bottom.green": "ʻO Chevron Green",
    "block.minecraft.banner.triangle_bottom.light_blue": "ʻO Chevron Blue Mālamalama",
    "block.minecraft.banner.triangle_bottom.light_gray": "Chevron Hinahina Māmā",
    "block.minecraft.banner.triangle_bottom.lime": "Lime Chevron",
    "block.minecraft.banner.triangle_bottom.magenta": "Magenta Chevro",
    "block.minecraft.banner.triangle_bottom.orange": "ʻO Cyan Chevron",
    "block.minecraft.banner.triangle_bottom.pink": "Pink Chevron",
    "block.minecraft.banner.triangle_bottom.purple": "'O Chevron Lila",
    "block.minecraft.banner.triangle_bottom.red": "Chevron ʻulaʻula",
    "block.minecraft.banner.triangle_bottom.white": "Chevron Keʻokeʻo",
    "block.minecraft.banner.triangle_bottom.yellow": "ʻO Chevron Yellow",
    "block.minecraft.banner.triangle_top.black": "Chevron Kahuli ʻEleʻele",
    "block.minecraft.banner.triangle_top.blue": "ʻO Chevron Kahuli Kahuli",
    "block.minecraft.banner.triangle_top.brown": "Chevron Kahuli Kahuli",
    "block.minecraft.banner.triangle_top.cyan": "ʻO Chevron hoʻohuli ʻia ʻo Cyan",
    "block.minecraft.banner.triangle_top.gray": "Chevron Kahuli Hewa",
    "block.minecraft.banner.triangle_top.green": "ʻO Chevron Kahuli Green",
    "block.minecraft.banner.triangle_top.light_blue": "ʻO Chevron Kahuli Kahuli Kahuli",
    "block.minecraft.banner.triangle_top.light_gray": "Chevron Kahuli ʻhinahina",
    "block.minecraft.banner.triangle_top.lime": "ʻO Chevron Lvert Inverted",
    "block.minecraft.banner.triangle_top.magenta": "ʻO Chevron hoʻohuli ʻia ʻo Magenta",
    "block.minecraft.banner.triangle_top.orange": "ʻO Chevron Kahuli ʻIlani",
    "block.minecraft.banner.triangle_top.pink": "ʻO Chevron Kahuli Huli",
    "block.minecraft.banner.triangle_top.purple": "Chevron Kahuli",
    "block.minecraft.banner.triangle_top.red": "Chevron Kahuli ʻUla",
    "block.minecraft.banner.triangle_top.white": "Chevron Kahuli Keʻokeʻo",
    "block.minecraft.banner.triangle_top.yellow": "Ua huli ʻo ʻO Chevron Lvert",
    "block.minecraft.banner.triangles_bottom.black": "Indented Base ʻEleʻele",
    "block.minecraft.banner.triangles_bottom.blue": "Indent Base Blue",
    "block.minecraft.banner.triangles_bottom.brown": "Indentment Base Brown",
    "block.minecraft.banner.triangles_bottom.cyan": "Indented Base Cyan",
    "block.minecraft.banner.triangles_bottom.gray": "ʻAnuʻu hina hina",
    "block.minecraft.banner.triangles_bottom.green": "Indent Base Kahuna",
    "block.minecraft.banner.triangles_bottom.light_blue": "Indented Base Kahuli Uila",
    "block.minecraft.banner.triangles_bottom.light_gray": "Indented Base Kahina Pākuʻi",
    "block.minecraft.banner.triangles_bottom.lime": "ʻAnuʻu Lime Hoʻokomo ʻia",
    "block.minecraft.banner.triangles_bottom.magenta": "Indent Base Magenta",
    "block.minecraft.banner.triangles_bottom.orange": "Indent Base Kahuna",
    "block.minecraft.banner.triangles_bottom.pink": "Indentis Base Kahuli",
    "block.minecraft.banner.triangles_bottom.purple": "Indent Base Kahuna",
    "block.minecraft.banner.triangles_bottom.red": "Indented Base ʻulaʻula",
    "block.minecraft.banner.triangles_bottom.white": "Indented Base Keʻokeʻo",
    "block.minecraft.banner.triangles_bottom.yellow": "ʻAnuʻu Yellow Yellow",
    "block.minecraft.banner.triangles_top.black": "Huli ʻia ke Aliʻi ʻEleʻele",
    ...
    "block.minecraft.black_banner": "Pākuʻi ʻEleʻele",
    ...
    "block.minecraft.blue_banner": "Paʻa polū",
    ...
    "block.minecraft.brown_banner": "Pākuʻi Brown",
    ...
    "block.minecraft.cyan_banner": "Pākuʻi Cyan",
    ...
    "block.minecraft.gray_banner": "Pākuʻi hina",
    ...
    "block.minecraft.green_banner": "Pākuʻi ʻōmaʻomaʻo",
    ...
    "block.minecraft.light_blue_banner": "Pāʻā Uila Māmā",
    ...
    "block.minecraft.light_gray_banner": "Paina Hinahina Māmā",
    ...
    "block.minecraft.lime_banner": "ʻĀlapa Lime",
    ...
    "block.minecraft.magenta_banner": "Mālama Magenta",
    ...
    "block.minecraft.orange_banner": "ʻĀlani ʻalani",
    ...
    "block.minecraft.pink_banner": "Pākuʻi ʻĀlani",
    ...
    "block.minecraft.purple_banner": "Pākuʻi Lila",
    ...
    "block.minecraft.red_banner": "Pākuʻi ʻulaʻula",
    ...
    "block.minecraft.yellow_banner": "Pākuʻi melemele",
    ...
    "item.minecraft.creeper_banner_pattern.desc": "Kauoha Creeper",
    ...
    "item.minecraft.debug_stick.select": "koho ʻia  (%s)",
    "item.minecraft.debug_stick.update": " i %s",
    ...
    "item.minecraft.flower_banner_pattern.desc": "Kauoha pua",
    ...
    "item.minecraft.globe_banner_pattern.desc": "Poepoe honua",
    ...
    "item.minecraft.lingering_potion.effect.awkward": "ʻAha Hoʻonā Awewe",
    "item.minecraft.lingering_potion.effect.empty": "ʻO Lingering Unotionable Potion",
    "item.minecraft.lingering_potion.effect.fire_resistance": "ʻO Lingering Potion o ke kūʻē ahi",
    "item.minecraft.lingering_potion.effect.harming": "ʻO Lingering Potion o ka hōʻino",
    "item.minecraft.lingering_potion.effect.healing": "Hoʻomaha lingering o ka hoʻōla",
    "item.minecraft.lingering_potion.effect.invisibility": "Lingering Potion o ka ʻike maka ʻole ʻia",
    "item.minecraft.lingering_potion.effect.leaping": "ʻO Lingering Potion o ka lele",
    ...
    "item.minecraft.lingering_potion.effect.mundane": "ʻO Mundane Lingering Potion",
    "item.minecraft.lingering_potion.effect.night_vision": "ʻO Lingering Potion o ka Hōʻike Po",
    ...
    "item.minecraft.lingering_potion.effect.slowness": "ʻO Lingering Potion o ka Lohi",
    "item.minecraft.lingering_potion.effect.strength": "Lingering Potion o ka ikaika",
    "item.minecraft.lingering_potion.effect.swiftness": "ʻO Lingering Potion o ka wikiwiki",
    "item.minecraft.lingering_potion.effect.thick": "Pākuʻi Lingering mānoanoa",
    "item.minecraft.lingering_potion.effect.turtle_master": "ʻO Lingering Potion o ke Kumu Honu",
    "item.minecraft.lingering_potion.effect.water": "ʻLemole wai lingering",
    "item.minecraft.lingering_potion.effect.water_breathing": "ʻO Lingering Potion o ka hanu wai",
    ...
    "item.minecraft.potion.effect.awkward": "Aloha ʻAha",
    "item.minecraft.potion.effect.empty": "ʻO Potion Uncraftable",
    "item.minecraft.potion.effect.fire_resistance": "Kaha o ke kūʻē ahi",
    "item.minecraft.potion.effect.harming": "Kiʻi o ka hōʻino",
    "item.minecraft.potion.effect.healing": "Kukui Hoola",
    "item.minecraft.potion.effect.invisibility": "Kiʻi o ka ʻike maka ʻole ʻia",
    "item.minecraft.potion.effect.leaping": "Kaha o ka Lele ʻana",
    "item.minecraft.potion.effect.levitation": "Kiʻi o ka Levi",
    "item.minecraft.potion.effect.luck": "Kiʻi o ka Laki",
    "item.minecraft.potion.effect.mundane": "ʻO Mundane Potion",
    "item.minecraft.potion.effect.night_vision": "Kaha o ka Hihi Po",
    "item.minecraft.potion.effect.poison": "Kiʻi o ka lāʻau make",
    "item.minecraft.potion.effect.regeneration": "Kiʻi o ka hoʻoulu hou ʻana",
    "item.minecraft.potion.effect.slow_falling": "Potion o ka hāʻule lohi",
    "item.minecraft.potion.effect.slowness": "Pili o ka Lohi",
    "item.minecraft.potion.effect.strength": "Kaha o ka ikaika",
    "item.minecraft.potion.effect.swiftness": "Kaha o ka wikiwiki",
    "item.minecraft.potion.effect.thick": "Pākuʻi mānoanoa",
    "item.minecraft.potion.effect.turtle_master": "Kiʻi o ka Haku Honu",
    "item.minecraft.potion.effect.water": "Mole wai",
    "item.minecraft.potion.effect.water_breathing": "Kaha o ka hanu wai",
    "item.minecraft.potion.effect.weakness": "Kaona o ka nāwaliwali",
    ...
    "item.minecraft.shield": "Pale kaua",
    "item.minecraft.shield.black": "Pale ʻeleʻele",
    "item.minecraft.shield.blue": "Pale Pulu",
    "item.minecraft.shield.brown": "Palekona Brown",
    "item.minecraft.shield.cyan": "Kāpena Cyan",
    "item.minecraft.shield.gray": "Pālei Pele",
    "item.minecraft.shield.green": "Pale ʻōmaʻomaʻo",
    "item.minecraft.shield.light_blue": "Pale Pulu Uila",
    "item.minecraft.shield.light_gray": "Pale Puʻukū Māmā",
    "item.minecraft.shield.lime": "Lime Shield",
    "item.minecraft.shield.magenta": "ʻO Magenta Shield",
    "item.minecraft.shield.orange": "Pale ʻAlani",
    "item.minecraft.shield.pink": "Pale Pale",
    "item.minecraft.shield.purple": "Pale Poni",
    "item.minecraft.shield.red": "Pale ʻulaʻula",
    ...
    "item.minecraft.skull_banner_pattern.desc": "Kāleka poʻo poʻo poʻo poʻo",
    ...
    "item.minecraft.splash_potion.effect.harming": "Splash Potion o ka hōʻeha",
    "item.minecraft.splash_potion.effect.healing": "Splash Potion of Healing",
    "item.minecraft.splash_potion.effect.invisibility": "Splash Potion o ka ʻike maka ʻole ʻia",
    "item.minecraft.splash_potion.effect.leaping": "Splash Potion o ka lele ʻana",
    "item.minecraft.splash_potion.effect.levitation": "ʻO Splash Potion o ka Levitation",
    "item.minecraft.splash_potion.effect.luck": "Splash Potion o Laki",
    "item.minecraft.splash_potion.effect.mundane": "ʻO Mundane Splash Potion",
    ...
    "item.minecraft.splash_potion.effect.regeneration": "ʻO Splash Potion o ka Hoʻohou Hou",
    "item.minecraft.splash_potion.effect.slow_falling": "Splash Potion o ka hāʻule lohi",
    "item.minecraft.splash_potion.effect.slowness": "Splash Potion o ka lohi",
    "item.minecraft.splash_potion.effect.strength": "Splash Potion o ka ikaika",
    ...
    "item.minecraft.splash_potion.effect.turtle_master": "ʻO Splash Potion o ke Kumu Honu",
    "item.minecraft.splash_potion.effect.water": "ʻLemole wai pīpī",
    "item.minecraft.splash_potion.effect.water_breathing": "Splash Potion of Water Breathing",
    "item.minecraft.splash_potion.effect.weakness": "Splash Potion o ka nāwaliwali",
    ...
    "item.minecraft.sweet_berries": "Nā hua berena",
    "item.minecraft.tipped_arrow": "Pākuʻi pūʻia",
    "item.minecraft.tipped_arrow.effect.awkward": "ʻĀlika ʻōlapa",
    "item.minecraft.tipped_arrow.effect.empty": "ʻĀpana Tipped Uncraftable",
    "item.minecraft.tipped_arrow.effect.fire_resistance": "Pana o ke ahi Kūʻē",
    "item.minecraft.tipped_arrow.effect.harming": "Pana o ka hōʻeha",
    "item.minecraft.tipped_arrow.effect.healing": "Pana o ka hoʻōla",
    "item.minecraft.tipped_arrow.effect.invisibility": "Pana o ka ʻike maka ʻole ʻia",
    "item.minecraft.tipped_arrow.effect.leaping": "Pana o ka lele ʻana",
    "item.minecraft.tipped_arrow.effect.levitation": "Pana o ka Levi",
    "item.minecraft.tipped_arrow.effect.luck": "ʻRowlau Laki",
    "item.minecraft.tipped_arrow.effect.mundane": "ʻĀlika ʻōlapa",
    "item.minecraft.tipped_arrow.effect.night_vision": "Pana o ka Hihi Po",
    "item.minecraft.tipped_arrow.effect.poison": "Pana o ka lāʻau make",
    "item.minecraft.tipped_arrow.effect.regeneration": "Pana o ka hana hou ʻana",
    "item.minecraft.tipped_arrow.effect.slow_falling": "Pana Haule Haule",
    "item.minecraft.tipped_arrow.effect.slowness": "ʻRowlau Lohi",
    "item.minecraft.tipped_arrow.effect.strength": "Pana o ka ikaika",
    "item.minecraft.tipped_arrow.effect.swiftness": "Pana o ka wikiwiki",
    "item.minecraft.tipped_arrow.effect.thick": "ʻĀlika ʻōlapa",
    "item.minecraft.tipped_arrow.effect.turtle_master": "Pana a ka Haku Honu",
    "item.minecraft.tipped_arrow.effect.water": "Pana o ka ʻulupā",
    "item.minecraft.tipped_arrow.effect.water_breathing": "Pana o ka hanu wai",
    "item.minecraft.tipped_arrow.effect.weakness": "Pana o ka nāwaliwali",
