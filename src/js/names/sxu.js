var items = {
    ...
    "block.minecraft.acacia_fence_gate": "Agazienhulzzaundor",
    ...
    "block.minecraft.acacia_sign": "Agazienhulzschild",
    ...
    "block.minecraft.acacia_wall_sign": "Agazienhulzwandschild",
    "block.minecraft.acacia_wood": "Agazienhulz",
    "block.minecraft.activator_rail": "Agdivierungsschiene",
    "block.minecraft.air": "Lufd",
    "block.minecraft.allium": "Schdernlooch",
    "block.minecraft.ancient_debris": "Andikor Schrodd",
    ...
    "block.minecraft.andesite_wall": "Andesidmauer",
    "block.minecraft.anvil": "Amboss",
    "block.minecraft.attached_melon_stem": "Melonrange",
    "block.minecraft.attached_pumpkin_stem": "Körbisschdängl",
    ...
    "block.minecraft.banner.border.lime": "Hellgrienor Bord",
    ...
    "block.minecraft.banner.border.red": "Rodor Bord",
    ...
    "block.minecraft.banner.circle.black": "Schworze Kuchl",
    "block.minecraft.banner.circle.blue": "Blaue Kuchl",
    "block.minecraft.banner.circle.brown": "Braune Kuchl",
    "block.minecraft.banner.circle.cyan": "Dürgise Kuchl",
    "block.minecraft.banner.circle.gray": "Graue Kuchl",
    "block.minecraft.banner.circle.green": "Griene Kuchl",
    "block.minecraft.banner.circle.light_blue": "Hellblaue Kuchl",
    "block.minecraft.banner.circle.light_gray": "Hellgraue Kuchl",
    "block.minecraft.banner.circle.lime": "Hellgriene Kuchl",
    "block.minecraft.banner.circle.magenta": "Magenda Kuchl",
    "block.minecraft.banner.circle.orange": "Orangsche Kuchl",
    "block.minecraft.banner.circle.pink": "Pinge Kuchl",
    "block.minecraft.banner.circle.purple": "Lila Kuchl",
    "block.minecraft.banner.circle.red": "Rode Kuchl",
    "block.minecraft.banner.circle.white": "Weeße Kuchl",
    "block.minecraft.banner.circle.yellow": "Gelbe Kuchl",
    "block.minecraft.banner.creeper.black": "Schworzor Creeper",
    "block.minecraft.banner.creeper.blue": "Blauor Creeper",
    "block.minecraft.banner.creeper.brown": "Braunor Creeper",
    "block.minecraft.banner.creeper.cyan": "Dürgisor Creeper",
    "block.minecraft.banner.creeper.gray": "Grauor Creeper",
    "block.minecraft.banner.creeper.green": "Grienor Creeper",
    "block.minecraft.banner.creeper.light_blue": "Hellblauor Creeper",
    "block.minecraft.banner.creeper.light_gray": "Hellgrauor Creeper",
    "block.minecraft.banner.creeper.lime": "Hellgrienor Creeper",
    "block.minecraft.banner.creeper.magenta": "Magenda Creeper",
    "block.minecraft.banner.creeper.orange": "Orangschor Creeper",
    "block.minecraft.banner.creeper.pink": "Pingor Creeper",
    "block.minecraft.banner.creeper.purple": "Lila Creeper",
    "block.minecraft.banner.creeper.red": "Rodor Creeper",
    "block.minecraft.banner.creeper.white": "Weeßorr Creeper",
    "block.minecraft.banner.creeper.yellow": "Gelbor Creeper",
    ...
    "block.minecraft.banner.curly_border.lime": "Hellgrienor Schbigglbord",
    ...
    "block.minecraft.banner.curly_border.red": "Rodor Schbigglbord",
    ...
    "block.minecraft.banner.diagonal_up_left.blue": "Blaue schrächreschds gedeild (Inverdiord)",
    ...
    "block.minecraft.banner.globe.lime": "Hellgrienor Globus",
    ...
    "block.minecraft.banner.globe.red": "Rodor Globus",
    "block.minecraft.banner.globe.white": "Weeßorr Globus",
    "block.minecraft.banner.globe.yellow": "Gelborr Globus",
    "block.minecraft.banner.gradient.black": "Schworzor Farbvorloof",
    "block.minecraft.banner.gradient.blue": "Blauor Farbvorloof",
    "block.minecraft.banner.gradient.brown": "Braunor Farbvorloof",
    "block.minecraft.banner.gradient.cyan": "Dürgisor Farbvorloof",
    "block.minecraft.banner.gradient.gray": "Grauor Farbvorloof",
    "block.minecraft.banner.gradient.green": "Grienor Farbvorloof",
    "block.minecraft.banner.gradient.light_blue": "Hellblauor Farbvorloof",
    "block.minecraft.banner.gradient.light_gray": "Hellgrauor Farbvorloof",
    "block.minecraft.banner.gradient.lime": "Hellgrienor Farbvorloof",
    "block.minecraft.banner.gradient.magenta": "Magenda Farbvorloof",
    "block.minecraft.banner.gradient.orange": "Orangschor Farbvorloof",
    "block.minecraft.banner.gradient.pink": "Pingor Farbvorloof",
    "block.minecraft.banner.gradient.purple": "Lila Farbvorloof",
    "block.minecraft.banner.gradient.red": "Rodor Farbvorloof",
    "block.minecraft.banner.gradient.white": "Weeßorr Farbvorrloof",
    "block.minecraft.banner.gradient.yellow": "Gelbor Farbvorloof",
    "block.minecraft.banner.gradient_up.black": "Schworzor Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.blue": "Blauor Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.brown": "Braunor Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.cyan": "Dürgisor Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.gray": "Grauor Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.green": "Grienor Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.light_blue": "Hellblauor Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.light_gray": "Hellgrauor Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.lime": "Hellgrienor Farbvorloof (Inverdierd)",
    "block.minecraft.banner.gradient_up.magenta": "Magenda Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.orange": "Orangschor Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.pink": "Pingor Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.purple": "Lila Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.red": "Rodor Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.white": "Weeßorr Farbvorloof (Inverdiord)",
    "block.minecraft.banner.gradient_up.yellow": "Gelbor Farbvorloof (Inverdiord)",
    ...
    "block.minecraft.banner.piglin.white": "Weiße Gusche",
    ...
    "block.minecraft.banner.skull.black": "Schworzor Nischl",
    "block.minecraft.banner.skull.blue": "Blauor Nischl",
    "block.minecraft.banner.skull.brown": "Braunor Nischl",
    "block.minecraft.banner.skull.cyan": "Dürgisor Nischl",
    "block.minecraft.banner.skull.gray": "Grauor Nischl",
    "block.minecraft.banner.skull.green": "Grienor Nischl",
    "block.minecraft.banner.skull.light_blue": "Hellblauor Nischl",
    "block.minecraft.banner.skull.light_gray": "Hellgrauor Nischl",
    "block.minecraft.banner.skull.lime": "Hellgrienor Schädl",
    "block.minecraft.banner.skull.magenta": "Magenda Nischl",
    "block.minecraft.banner.skull.orange": "Orangschor Nischl",
    "block.minecraft.banner.skull.pink": "Pingor Nischl",
    "block.minecraft.banner.skull.purple": "Lila Nischl",
    "block.minecraft.banner.skull.red": "Rodor Nischl",
    "block.minecraft.banner.skull.white": "Weeßorr Nischl",
    "block.minecraft.banner.skull.yellow": "Gelbor Nischl",
    "block.minecraft.banner.small_stripes.black": "Fior schworze Pfähle",
    "block.minecraft.banner.small_stripes.blue": "Fior blaue Pfähle",
    "block.minecraft.banner.small_stripes.brown": "Fior braune Pfähle",
    "block.minecraft.banner.small_stripes.cyan": "Fior dürgise Pfähle",
    "block.minecraft.banner.small_stripes.gray": "Fior graue Pfähle",
    "block.minecraft.banner.small_stripes.green": "Fior griene Pfähle",
    "block.minecraft.banner.small_stripes.light_blue": "Fior hellblaue Pfähle",
    "block.minecraft.banner.small_stripes.light_gray": "Fior hellgraue Pfähle",
    "block.minecraft.banner.small_stripes.lime": "Fior hellgriene Pfähle",
    "block.minecraft.banner.small_stripes.magenta": "Fior magenda Pfähle",
    "block.minecraft.banner.small_stripes.orange": "Fior orangsche Pfähle",
    "block.minecraft.banner.small_stripes.pink": "Fior pinge Pfähle",
    "block.minecraft.banner.small_stripes.purple": "Fior lila Pfähle",
    "block.minecraft.banner.small_stripes.red": "Fior rode Pfähle",
    "block.minecraft.banner.small_stripes.white": "Fior weeße Pfähle",
    "block.minecraft.banner.small_stripes.yellow": "Fior gelbe Pfähle",
    "block.minecraft.banner.square_bottom_left.black": "Schworzes reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.blue": "Blaues reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.brown": "Braunes reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.cyan": "Dürgises reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.gray": "Graues reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.green": "Grienes reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.light_blue": "Hellblaues reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.light_gray": "Hellgraues reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.lime": "Hellgrienes reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.magenta": "Magenda reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.orange": "Orangsches reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.pink": "Pinges reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.purple": "Lila reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.red": "Rodes reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.white": "Weeßes reschdes Undoregg",
    "block.minecraft.banner.square_bottom_left.yellow": "Gelbes reschdes Undoregg",
    "block.minecraft.banner.square_bottom_right.black": "Schworzes linges Undoregg",
    "block.minecraft.banner.square_bottom_right.blue": "Blaues linges Undoregg",
    "block.minecraft.banner.square_bottom_right.brown": "Braunes linges Undoregg",
    "block.minecraft.banner.square_bottom_right.cyan": "Dürgises linges Undoregg",
    "block.minecraft.banner.square_bottom_right.gray": "Graues linges Undoregg",
    "block.minecraft.banner.square_bottom_right.green": "Grienes linges Undoregg",
    "block.minecraft.banner.square_bottom_right.light_blue": "Hellblaues linges Undoregg",
    "block.minecraft.banner.square_bottom_right.light_gray": "Hellgraues linges Undoregg",
    "block.minecraft.banner.square_bottom_right.lime": "Hellgrienes linges Undoregg",
    "block.minecraft.banner.square_bottom_right.magenta": "Magenda linges Undoregg",
    "block.minecraft.banner.square_bottom_right.orange": "Orangsches linges Undoregg",
    "block.minecraft.banner.square_bottom_right.pink": "Pinges linges Undoregg",
    "block.minecraft.banner.square_bottom_right.purple": "Lila linges Undoregg",
    "block.minecraft.banner.square_bottom_right.red": "Rodes linges Undoregg",
    "block.minecraft.banner.square_bottom_right.white": "Weeßes linges Undoregg",
    "block.minecraft.banner.square_bottom_right.yellow": "Gelbes linges Undoregg",
    "block.minecraft.banner.square_top_left.black": "Schworzes reschdes Oboregg",
    "block.minecraft.banner.square_top_left.blue": "Blaues reschdes Oboregg",
    "block.minecraft.banner.square_top_left.brown": "Braunes reschdes Oboregg",
    "block.minecraft.banner.square_top_left.cyan": "Dürgises reschdes Oboregg",
    "block.minecraft.banner.square_top_left.gray": "Graues reschdes Oboregg",
    "block.minecraft.banner.square_top_left.green": "Grienes reschdes Oboregg",
    "block.minecraft.banner.square_top_left.light_blue": "Hellblaues reschdes Oboregg",
    "block.minecraft.banner.square_top_left.light_gray": "Hellgraues reschdes Oboregg",
    "block.minecraft.banner.square_top_left.lime": "Hellgrienes reschdes Oboregg",
    "block.minecraft.banner.square_top_left.magenta": "Lila reschdes Oboregg",
    "block.minecraft.banner.square_top_left.orange": "Orangsches reschdes Oboregg",
    "block.minecraft.banner.square_top_left.pink": "Pinges reschdes Oboregg",
    "block.minecraft.banner.square_top_left.purple": "Lila reschdes Oboregg",
    "block.minecraft.banner.square_top_left.red": "Rodes reschdes Oboregg",
    "block.minecraft.banner.square_top_left.white": "Weeßes reschdes Oboregg",
    "block.minecraft.banner.square_top_left.yellow": "Gelbes reschdes Oboregg",
    "block.minecraft.banner.square_top_right.black": "Schworzes linges Oboregg",
    "block.minecraft.banner.square_top_right.blue": "Blaues linges Oboregg",
    "block.minecraft.banner.square_top_right.brown": "Braunes linges Oboregg",
    "block.minecraft.banner.square_top_right.cyan": "Dürgises linges Oboregg",
    "block.minecraft.banner.square_top_right.gray": "Graues linges Oboregg",
    "block.minecraft.banner.square_top_right.green": "Grienes linges Oboregg",
    "block.minecraft.banner.square_top_right.light_blue": "Hellblaues linges Oboregg",
    "block.minecraft.banner.square_top_right.light_gray": "Hellgraues linges Oboregg",
    "block.minecraft.banner.square_top_right.lime": "Hellgrienes linges Oboregg",
    "block.minecraft.banner.square_top_right.magenta": "Lila linges Oboregg",
    "block.minecraft.banner.square_top_right.orange": "Orangsches linges Oboregg",
    "block.minecraft.banner.square_top_right.pink": "Pinges linges Oboregg",
    "block.minecraft.banner.square_top_right.purple": "Lila linges Oboregg",
    "block.minecraft.banner.square_top_right.red": "Rodes linges Oboregg",
    "block.minecraft.banner.square_top_right.white": "Weeßes linges Oboregg",
    "block.minecraft.banner.square_top_right.yellow": "Gelbes linges Oboregg",
    ...
    "block.minecraft.banner.stripe_bottom.black": "Schworzor Bannorfuß",
    "block.minecraft.banner.stripe_bottom.blue": "Blauor Bannorfuß",
    "block.minecraft.banner.stripe_bottom.brown": "Braunor Bannorfuß",
    "block.minecraft.banner.stripe_bottom.cyan": "Dürgisor Bannorfuß",
    "block.minecraft.banner.stripe_bottom.gray": "Grauor Bannorfuß",
    "block.minecraft.banner.stripe_bottom.green": "Grienor Bannorfuß",
    "block.minecraft.banner.stripe_bottom.light_blue": "Hellblauor Bannorfuß",
    "block.minecraft.banner.stripe_bottom.light_gray": "Hellgrauor Bannorfuß",
    "block.minecraft.banner.stripe_bottom.lime": "Hellgrienor Bannorfuß",
    "block.minecraft.banner.stripe_bottom.magenta": "Magenda Bannorfuß",
    "block.minecraft.banner.stripe_bottom.orange": "Orangschor Bannorfuß",
    "block.minecraft.banner.stripe_bottom.pink": "Pingor Bannorfuß",
    "block.minecraft.banner.stripe_bottom.purple": "Lila Bannorfuß",
    "block.minecraft.banner.stripe_bottom.red": "Rodor Bannorfuß",
    "block.minecraft.banner.stripe_bottom.white": "Weeßorr Bannorfuß",
    "block.minecraft.banner.stripe_bottom.yellow": "Gelbor Bannorfuß",
    ...
    "block.minecraft.banner.stripe_center.red": "Rodor Pfahl",
    "block.minecraft.banner.stripe_center.white": "Weeßorr Pfahl",
    "block.minecraft.banner.stripe_center.yellow": "Gelborr Pfahl",
    "block.minecraft.banner.stripe_downleft.black": "Schworzor Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.blue": "Blauor Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.brown": "Braunor Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.cyan": "Dürgisor Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.gray": "Grauor Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.green": "Grienor Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.light_blue": "Hellblauor Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.light_gray": "Hellgrauor Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.lime": "Hellgrienor Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.magenta": "Magenda Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.orange": "Orangschor Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.pink": "Pingor Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.purple": "Lila Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.red": "Rodor Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.white": "Weeßorr Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downleft.yellow": "Gelbor Schrächlingsbalgn",
    "block.minecraft.banner.stripe_downright.black": "Schworzor Schrächbalgn",
    "block.minecraft.banner.stripe_downright.blue": "Blauor Schrächbalgn",
    "block.minecraft.banner.stripe_downright.brown": "Braunor Schrächbalgn",
    "block.minecraft.banner.stripe_downright.cyan": "Dürgisor Schrächbalgn",
    "block.minecraft.banner.stripe_downright.gray": "Grauor Schrächbalgn",
    "block.minecraft.banner.stripe_downright.green": "Grienor Schrächbalgn",
    "block.minecraft.banner.stripe_downright.light_blue": "Hellblooer Schrächbalschn",
    "block.minecraft.banner.stripe_downright.light_gray": "Hellgrauor Schrächbalgn",
    "block.minecraft.banner.stripe_downright.lime": "Hellgriener Schrächbalschn",
    "block.minecraft.banner.stripe_downright.magenta": "Magenta Schrächbalschn",
    "block.minecraft.banner.stripe_downright.orange": "Orangscher Schrächbalschn",
    "block.minecraft.banner.stripe_downright.pink": "Pingor Schrächbalgn",
    "block.minecraft.banner.stripe_downright.purple": "Lila Schrächbalgn",
    "block.minecraft.banner.stripe_downright.red": "Rodor Schrächbalgn",
    "block.minecraft.banner.stripe_downright.white": "Weeßer Schrächbalschn",
    "block.minecraft.banner.stripe_downright.yellow": "Gelber Schrächbalschn",
    ...
    "block.minecraft.banner.stripe_middle.black": "Schworzer Balschn",
    "block.minecraft.banner.stripe_middle.blue": "Blooer Balschn",
    "block.minecraft.banner.stripe_middle.brown": "Brauner Balschn",
    "block.minecraft.banner.stripe_middle.cyan": "Dürgiser Balschn",
    "block.minecraft.banner.stripe_middle.gray": "Grauer Balschn",
    "block.minecraft.banner.stripe_middle.green": "Griener Balschn",
    "block.minecraft.banner.stripe_middle.light_blue": "Hellblooer Balschn",
    "block.minecraft.banner.stripe_middle.light_gray": "Hellgrauer Balschn",
    "block.minecraft.banner.stripe_middle.lime": "Hellgriener Balschn",
    "block.minecraft.banner.stripe_middle.magenta": "Magenda Balgn",
    "block.minecraft.banner.stripe_middle.orange": "Orangschor Balgn",
    "block.minecraft.banner.stripe_middle.pink": "Pinger Balschn",
    "block.minecraft.banner.stripe_middle.purple": "Lila Balschn",
    "block.minecraft.banner.stripe_middle.red": "Roder Balschn",
    "block.minecraft.banner.stripe_middle.white": "Weeßorr Balgn",
    "block.minecraft.banner.stripe_middle.yellow": "Gelber Balschn",
    ...
    "block.minecraft.banner.stripe_top.black": "Schworzes Bannorhaubd",
    "block.minecraft.banner.stripe_top.blue": "Blaues Bannorhaubd",
    "block.minecraft.banner.stripe_top.brown": "Braunes Bannorhaubd",
    "block.minecraft.banner.stripe_top.cyan": "Dürgises Bannorhaubd",
    "block.minecraft.banner.stripe_top.gray": "Graues Bannorhaubd",
    "block.minecraft.banner.stripe_top.green": "Grienes Bannorhaubd",
    "block.minecraft.banner.stripe_top.light_blue": "Hellblaues Bannorhaubd",
    "block.minecraft.banner.stripe_top.light_gray": "Hellgraues Bannorhaubd",
    "block.minecraft.banner.stripe_top.lime": "Hellgrienes Bannorhaubd",
    "block.minecraft.banner.stripe_top.magenta": "Magenda Bannorhaubd",
    "block.minecraft.banner.stripe_top.orange": "Orangsches Bannorhaubd",
    "block.minecraft.banner.stripe_top.pink": "Pinges Bannorhaubd",
    "block.minecraft.banner.stripe_top.purple": "Lila Bannorhaubd",
    "block.minecraft.banner.stripe_top.red": "Rodes Bannorhaubd",
    "block.minecraft.banner.stripe_top.white": "Weeßes Bannorhaubd",
    "block.minecraft.banner.stripe_top.yellow": "Gelbes Bannorhaubd",
    ...
    "block.minecraft.banner.triangles_bottom.black": "Schworzor geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.blue": "Blauor geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.brown": "Braunor geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.cyan": "Dürgisor geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.gray": "Grauor geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.green": "Grienor geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.light_blue": "Hellblauor geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.light_gray": "Hellgrauor geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.lime": "Hellgrienor geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.magenta": "Magenda geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.orange": "Orangschor geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.pink": "Pingor geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.purple": "Lila geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.red": "Rodor geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_bottom.white": "Weeßorr geschbiggeldor Bannorrfuß",
    "block.minecraft.banner.triangles_bottom.yellow": "Gelbor geschbiggeldor Bannorfuß",
    "block.minecraft.banner.triangles_top.black": "Schworzes geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.blue": "Blaues geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.brown": "Braunes geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.cyan": "Dürgises geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.gray": "Graues geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.green": "Grienes geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.light_blue": "Hellblaues geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.light_gray": "Hellgraues geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.lime": "Hellgrienes geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.magenta": "Magenda geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.orange": "Orangsches geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.pink": "Pinges geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.purple": "Lila geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.red": "Rodes geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.white": "Weeßes geschbiggeldes Bannorhaubd",
    "block.minecraft.banner.triangles_top.yellow": "Gelbes geschbiggeldes Bannorhaubd",
    "block.minecraft.barrel": "Fass",
    "block.minecraft.barrier": "Borriere",
    "block.minecraft.basalt": "Basald",
    "block.minecraft.beacon": "Leuschdfeuor",
    "block.minecraft.beacon.primary": "Primäre Grafd",
    "block.minecraft.beacon.secondary": "Sekundäre Grafd",
    "block.minecraft.bed.no_sleep": "Du kannst nur während Gewittern oder in der Nacht schlafen",
    ...
    "block.minecraft.birch_fence_gate": "Bürschnhulzzaundor",
    "block.minecraft.birch_leaves": "Bürschnlaub",
    "block.minecraft.birch_log": "Bürschnhulz",
    ...
    "block.minecraft.birch_sign": "Bürschnhulzschild",
    ...
    "block.minecraft.birch_wall_sign": "Bürschnhulzwandschild",
    "block.minecraft.birch_wood": "Bürschnhulz",
    "block.minecraft.black_banner": "Schworzes Bannor",
    "block.minecraft.black_bed": "Schworzes Bädde",
    "block.minecraft.black_carpet": "Schwarzor Täppsch",
    ...
    "block.minecraft.black_shulker_box": "Schworze Shulkergissde",
    ...
    "block.minecraft.blast_furnace": "Hochoofn",
    "block.minecraft.blue_banner": "Blaues Bannor",
    "block.minecraft.blue_bed": "Blaues Bädde",
    "block.minecraft.blue_carpet": "Blauor Täppsch",
    ...
    "block.minecraft.blue_orchid": "Blooe Orchidee",
    "block.minecraft.blue_shulker_box": "Blaue Shulkergissde",
    ...
    "block.minecraft.brain_coral_block": "Hirngorallenblogg",
    "block.minecraft.brain_coral_fan": "Hirngorallenfäschor",
    "block.minecraft.brain_coral_wall_fan": "Hirngorallenwandfäschor",
    ...
    "block.minecraft.brick_wall": "Zieschlschdeenmauer",
    "block.minecraft.bricks": "Zieschel",
    "block.minecraft.brown_banner": "Braunes Bannor",
    "block.minecraft.brown_bed": "Braunes Bädde",
    "block.minecraft.brown_carpet": "Braunor Täppsch",
    ...
    "block.minecraft.brown_mushroom": "Braunor Bilz",
    "block.minecraft.brown_mushroom_block": "Braunor Bilzblogg",
    "block.minecraft.brown_shulker_box": "Braune Shulkergissde",
    ...
    "block.minecraft.bubble_coral": "Blosengoralle",
    "block.minecraft.bubble_coral_block": "Blosengorallenblogg",
    "block.minecraft.bubble_coral_fan": "Blosengorallenfäschor",
    "block.minecraft.bubble_coral_wall_fan": "Blosengorallenwandfäschor",
    "block.minecraft.cactus": "Kaggdus",
    "block.minecraft.cake": "Guhchn",
    "block.minecraft.campfire": "Gnäggerchn",
    "block.minecraft.carrots": "Möhrn",
    "block.minecraft.cartography_table": "Kardntüsch",
    "block.minecraft.carved_pumpkin": "Geschnidzder Körbis",
    "block.minecraft.cauldron": "Dobb",
    "block.minecraft.cave_air": "Höhlnlufd",
    "block.minecraft.chain": "Vorkeddn",
    "block.minecraft.chain_command_block": "Keddn-Befählsblogg",
    "block.minecraft.chest": "Druhe",
    "block.minecraft.chipped_anvil": "Angeschlagnor Amboss",
    "block.minecraft.chiseled_nether_bricks": "Gemeeßelde Netherzieschl",
    "block.minecraft.chiseled_polished_blackstone": "Gemeeßelder bohlierder Schworzschdeen",
    "block.minecraft.chiseled_quartz_block": "Gemeißeldor Quarzblogg",
    "block.minecraft.chiseled_red_sandstone": "Gemeißeldor rodor Sandschdeen",
    "block.minecraft.chiseled_sandstone": "Gemeeßelder Sandsteen",
    "block.minecraft.chiseled_stone_bricks": "Gemeeßelde Steenzieschel",
    ...
    "block.minecraft.comparator": "Redstone-Gombarador",
    "block.minecraft.composter": "Gomboschdor",
    "block.minecraft.conduit": "Lifter",
    "block.minecraft.cornflower": "Gornblume",
    "block.minecraft.cracked_nether_bricks": "Riss'sche Netherzieschl",
    "block.minecraft.cracked_polished_blackstone_bricks": "Rissische bohlierde Schworzschdeenzieschel",
    "block.minecraft.cracked_stone_bricks": "Rissische Steenzieschel",
    "block.minecraft.crafting_table": "Werschbang",
    ...
    "block.minecraft.crimson_door": "Garmesindür",
    "block.minecraft.crimson_fence": "Garmesinzaun",
    "block.minecraft.crimson_fence_gate": "Garmesinzaundor",
    "block.minecraft.crimson_fungus": "Garmesinpilz",
    "block.minecraft.crimson_hyphae": "Garmesinhyphen",
    "block.minecraft.crimson_nylium": "Garmesin-Nätzel",
    "block.minecraft.crimson_planks": "Garmesinbredder",
    "block.minecraft.crimson_pressure_plate": "Garmesindrugbladde",
    "block.minecraft.crimson_roots": "Garmesinwurzeln",
    "block.minecraft.crimson_sign": "Garmesinschild",
    "block.minecraft.crimson_slab": "Garmesinschdufe",
    "block.minecraft.crimson_stairs": "Garmesindrebbe",
    "block.minecraft.crimson_stem": "Garmesinstiel",
    "block.minecraft.crimson_trapdoor": "Garmesinfalldür",
    "block.minecraft.crimson_wall_sign": "Garmesinwandschild",
    "block.minecraft.crying_obsidian": "Ninglndor Obsidian",
    "block.minecraft.cut_red_sandstone": "Geschniddnor rodor Sandschdeen",
    "block.minecraft.cut_red_sandstone_slab": "Geschniddene rode Sandschdeenschdufe",
    "block.minecraft.cut_sandstone": "Geschniddener Sandsteen",
    "block.minecraft.cut_sandstone_slab": "Geschniddene Sandschdeenschdufe",
    "block.minecraft.cyan_banner": "Dürgises Bannor",
    "block.minecraft.cyan_bed": "Dürgises Bädde",
    "block.minecraft.cyan_carpet": "Dürgisor Täppsch",
    ...
    "block.minecraft.cyan_shulker_box": "Dürgise Shulkergissde",
    ...
    "block.minecraft.damaged_anvil": "Beschädigdor Amboss",
    "block.minecraft.dandelion": "Leewenzohn",
    ...
    "block.minecraft.dark_oak_fence_gate": "Schworzeischnhulzzaundor",
    ...
    "block.minecraft.dark_oak_sign": "Schworzeischnhulzschild",
    ...
    "block.minecraft.dark_oak_wall_sign": "Schworzeischnhulzwandschild",
    "block.minecraft.dark_oak_wood": "Schworzeischnhulz",
    "block.minecraft.dark_prismarine": "Dunglor Prismarin",
    "block.minecraft.dark_prismarine_slab": "Dungle Prismarinschdufe",
    "block.minecraft.dark_prismarine_stairs": "Dungle Brismarindrebbe",
    "block.minecraft.daylight_detector": "Daacheslischdsensor",
    "block.minecraft.dead_brain_coral": "Abgeschdorbene Hirngoralle",
    "block.minecraft.dead_brain_coral_block": "Abgeschdorbener Hirngorallenblogg",
    "block.minecraft.dead_brain_coral_fan": "Abgeschdorbener Hirngorallenfäschor",
    "block.minecraft.dead_brain_coral_wall_fan": "Abgeschdorbener Hirngorallenwandfäschor",
    "block.minecraft.dead_bubble_coral": "Abgeschdorbene Blosengoralle",
    "block.minecraft.dead_bubble_coral_block": "Abgeschdorbener Blosengorallenblogg",
    "block.minecraft.dead_bubble_coral_fan": "Abgeschdorbener Blosengorallenfäschor",
    "block.minecraft.dead_bubble_coral_wall_fan": "Abgeschdorbener Blosengorallenwandfäschor",
    "block.minecraft.dead_bush": "Todor Busch",
    "block.minecraft.dead_fire_coral": "Abgeschdorbene Feiergoralle",
    "block.minecraft.dead_fire_coral_block": "Abgeschdorbener Feiergorallenblogg",
    "block.minecraft.dead_fire_coral_fan": "Abgeschdorbener Feiergorallenfäschor",
    "block.minecraft.dead_fire_coral_wall_fan": "Abgeschdorbener Feiergorallenwandfäschor",
    "block.minecraft.dead_horn_coral": "Abgeschdorbene Geweehgoralle",
    "block.minecraft.dead_horn_coral_block": "Abgeschdorbener Runzelgorallenblogg",
    "block.minecraft.dead_horn_coral_fan": "Abgeschdorbener Geweehgorallenfäschor",
    "block.minecraft.dead_horn_coral_wall_fan": "Abgeschdorbener Geweehgorallenwandfäschor",
    "block.minecraft.dead_tube_coral": "Abgeschdorbene Orschelgoralle",
    "block.minecraft.dead_tube_coral_block": "Abgeschdorbener Orschelgorallenblogg",
    "block.minecraft.dead_tube_coral_fan": "Abgeschdorbener Orschelgorallenfäschor",
    "block.minecraft.dead_tube_coral_wall_fan": "Abgeschdorbener Orschelgorallenwandfäschor",
    ...
    "block.minecraft.diorite_slab": "Dioritschtufe",
    "block.minecraft.diorite_stairs": "Diorittrebbe",
    "block.minecraft.diorite_wall": "Dioritmauer",
    "block.minecraft.dirt": "Ährde",
    "block.minecraft.dispenser": "Werfor",
    ...
    "block.minecraft.dried_kelp_block": "Gedroggneder Seedangblogg",
    "block.minecraft.dropper": "Spendor",
    ...
    "block.minecraft.fire": "Rodes Feier",
    "block.minecraft.fire_coral": "Feiergoralle",
    "block.minecraft.fire_coral_block": "Feiergorallenblogg",
    "block.minecraft.fire_coral_fan": "Feiergorallenfäschor",
    "block.minecraft.fire_coral_wall_fan": "Feiergorallenwandfäschor",
    "block.minecraft.fletching_table": "Bochnortüsch",
    "block.minecraft.flower_pot": "Bluhmdobb",
    "block.minecraft.frosted_ice": "Brüschiges Eis",
    "block.minecraft.furnace": "Ofen",
    "block.minecraft.gilded_blackstone": "Golddurchzochener Schworzschdeen",
    "block.minecraft.glass": "Glas",
    "block.minecraft.glass_pane": "Glasscheebe",
    "block.minecraft.glowstone": "Glowsteen",
    "block.minecraft.gold_block": "Goldblogg",
    "block.minecraft.gold_ore": "Goldärds",
    "block.minecraft.granite": "Granid",
    "block.minecraft.granite_slab": "Granitschtufe",
    "block.minecraft.granite_stairs": "Granittrebbe",
    "block.minecraft.granite_wall": "Granitmauer",
    "block.minecraft.grass": "Gras",
    "block.minecraft.grass_block": "Grasblogg",
    "block.minecraft.grass_path": "Latschpfad",
    "block.minecraft.gravel": "Gies",
    "block.minecraft.gray_banner": "Graues Bannor",
    "block.minecraft.gray_bed": "Graues Bädde",
    "block.minecraft.gray_carpet": "Grauor Täppsch",
    ...
    "block.minecraft.gray_shulker_box": "Graue Shulkergissde",
    ...
    "block.minecraft.green_banner": "Grienes Bannor",
    "block.minecraft.green_bed": "Grienes Bädde",
    "block.minecraft.green_carpet": "Grünor Täppsch",
    ...
    "block.minecraft.green_shulker_box": "Griene Shulkergissde",
    ...
    "block.minecraft.horn_coral": "Geweehgoralle",
    "block.minecraft.horn_coral_block": "Runzelgorallenblogg",
    "block.minecraft.horn_coral_fan": "Geweehgorallenfäschor",
    "block.minecraft.horn_coral_wall_fan": "Geweehgorallenwandfäschor",
    "block.minecraft.ice": "Eis",
    "block.minecraft.infested_chiseled_stone_bricks": "Befallene gemeeßelde Schdeenzieschl",
    "block.minecraft.infested_cobblestone": "Befallenor Bruchschdeen",
    "block.minecraft.infested_cracked_stone_bricks": "Befallenor riss'schor Schdeenzieschl",
    "block.minecraft.infested_mossy_stone_bricks": "Befallene bemoosde Schdeenzieschl",
    "block.minecraft.infested_stone": "Befallenor Schdeen",
    "block.minecraft.infested_stone_bricks": "Befallene Schdeenzieschl",
    "block.minecraft.iron_bars": "Eisngiddor",
    "block.minecraft.iron_block": "Eisnblogg",
    "block.minecraft.iron_door": "Eesendiere",
    "block.minecraft.iron_ore": "Eisnärds",
    "block.minecraft.iron_trapdoor": "Eesenfalldiere",
    "block.minecraft.jack_o_lantern": "Körbisladerne",
    "block.minecraft.jigsaw": "Puschlblogg",
    ...
    "block.minecraft.jungle_fence_gate": "Drobnhulzzaundor",
    ...
    "block.minecraft.jungle_sign": "Drobnhulzschild",
    ...
    "block.minecraft.jungle_wall_sign": "Drobnhulzwandschild",
    "block.minecraft.jungle_wood": "Drobnhulz",
    "block.minecraft.kelp": "Seedang",
    "block.minecraft.kelp_plant": "Seedangschdängl",
    "block.minecraft.ladder": "Leider",
    "block.minecraft.lantern": "Funnsel",
    "block.minecraft.lapis_block": "Labislazuliblogg",
    "block.minecraft.lapis_ore": "Labislazuliärds",
    "block.minecraft.large_fern": "Großor Farn",
    "block.minecraft.lava": "Lava",
    "block.minecraft.lectern": "Lesebuld",
    "block.minecraft.lever": "Hebel",
    "block.minecraft.light_blue_banner": "Hellblaues Bannor",
    "block.minecraft.light_blue_bed": "Hellblaues Bädde",
    "block.minecraft.light_blue_carpet": "Hellblauor Täppsch",
    ...
    "block.minecraft.light_blue_shulker_box": "Hellblaue Shulkergissde",
    ...
    "block.minecraft.light_gray_banner": "Hellgraues Bannor",
    "block.minecraft.light_gray_bed": "Hellgraues Bädde",
    "block.minecraft.light_gray_carpet": "Hellgrauor Täppsch",
    ...
    "block.minecraft.light_gray_shulker_box": "Hellgraue Shulkergissde",
    ...
    "block.minecraft.light_weighted_pressure_plate": "Feenwäschebladde",
    "block.minecraft.lilac": "Fliedor",
    "block.minecraft.lily_of_the_valley": "Maiglöggschn",
    "block.minecraft.lily_pad": "Seerosnbladd",
    "block.minecraft.lime_banner": "Hellgrienes Bannor",
    "block.minecraft.lime_bed": "Hellgrienes Bädde",
    "block.minecraft.lime_carpet": "Hellgrienor Täppsch",
    ...
    "block.minecraft.lime_shulker_box": "Hellgriene Shulkergissde",
    ...
    "block.minecraft.magenta_banner": "Magenda Bannor",
    ...
    "block.minecraft.magenta_shulker_box": "Magenda Shulkergissde",
    ...
    "block.minecraft.melon_stem": "Melonbflanze",
    "block.minecraft.mossy_cobblestone": "Bemoosdor Bruchschdeen",
    ...
    "block.minecraft.mossy_stone_brick_stairs": "Bemooste Schdeenzieschltrebbe",
    "block.minecraft.mossy_stone_brick_wall": "Bemoosde Schdeenzieschlmauor",
    "block.minecraft.mossy_stone_bricks": "Bemoosde Steenzieschel",
    "block.minecraft.moving_piston": "Beweschder Blogg",
    ...
    "block.minecraft.nether_brick_wall": "Netherzieschlmauer",
    "block.minecraft.nether_bricks": "Netherzieschl",
    "block.minecraft.nether_gold_ore": "Nethergoldärz",
    "block.minecraft.nether_portal": "Nädderportal",
    ...
    "block.minecraft.oak_fence_gate": "Eischnhulzzaundor",
    ...
    "block.minecraft.oak_sign": "Eischnhulzschild",
    ...
    "block.minecraft.oak_wall_sign": "Eischnhulzwandschild",
    "block.minecraft.oak_wood": "Eischnhulz",
    "block.minecraft.observer": "Beobachdor",
    "block.minecraft.obsidian": "Obsidian",
    "block.minecraft.ominous_banner": "Unheelvolles Bannor",
    "block.minecraft.orange_banner": "Orangsches Bannor",
    "block.minecraft.orange_bed": "Orangsches Bädde",
    "block.minecraft.orange_carpet": "Orangschnor Täppsch",
    ...
    "block.minecraft.orange_shulker_box": "Orangschne Shulkergissde",
    ...
    "block.minecraft.petrified_oak_slab": "Vorrschdeenorde Eischnhulzschdufe",
    "block.minecraft.pink_banner": "Pinges Bannor",
    ...
    "block.minecraft.pink_shulker_box": "Pinge Shulkergissde",
    ...
    "block.minecraft.piston": "Kulbn",
    "block.minecraft.piston_head": "Kulbnkopp",
    "block.minecraft.player_head": "Schbielorkopp",
    "block.minecraft.player_head.named": "Nischl von %s",
    "block.minecraft.player_wall_head": "Schbielor-Wandnischl",
    "block.minecraft.podzol": "Podsol",
    "block.minecraft.polished_andesite": "Bolierdor Andesid",
    ...
    "block.minecraft.polished_basalt": "Bohlierder Basald",
    "block.minecraft.polished_blackstone": "Bohlierder Schworzschdeen",
    "block.minecraft.polished_blackstone_brick_slab": "Bohlierde Schworzschdeenzieschelschdufe",
    "block.minecraft.polished_blackstone_brick_stairs": "Bohlierde Schworzschdeenziescheldrebbe",
    "block.minecraft.polished_blackstone_brick_wall": "Bohlierde Schworzschdeenzieschelmauer",
    "block.minecraft.polished_blackstone_bricks": "Bohlierde Schworzschdeenzieschel",
    "block.minecraft.polished_blackstone_button": "Bohlierder Schworzschdeengnopp",
    "block.minecraft.polished_blackstone_pressure_plate": "Bohlierde Schworzschdeendrugbladde",
    "block.minecraft.polished_blackstone_slab": "Bohlierde Schworzschdeenschdufe",
    "block.minecraft.polished_blackstone_stairs": "Bohlierde Schworzschdeendrebbe",
    "block.minecraft.polished_blackstone_wall": "Bohlierde Schworzschdeenmauer",
    "block.minecraft.polished_diorite": "Bolierter Diorid",
    "block.minecraft.polished_diorite_slab": "Bolierte Dioritschtufe",
    "block.minecraft.polished_diorite_stairs": "Bolierte Diorittrebbe",
    "block.minecraft.polished_granite": "Bolierter Granid",
    "block.minecraft.polished_granite_slab": "Bolierte Granitschtufe",
    "block.minecraft.polished_granite_stairs": "Bolierte Granittrebbe",
    "block.minecraft.poppy": "Mohn",
    "block.minecraft.potatoes": "Ärbern",
    "block.minecraft.potted_acacia_sapling": "Eingedobbdor Agazienseddsling",
    "block.minecraft.potted_allium": "Eingedobbdor Schdernlauch",
    "block.minecraft.potted_azure_bluet": "Eingedobbdes Porzellanschdernschn",
    "block.minecraft.potted_bamboo": "Eingedobbdor Bambus",
    "block.minecraft.potted_birch_sapling": "Eingedobbdor Bürschnseddsling",
    "block.minecraft.potted_blue_orchid": "Eingedobbde blaue Orchidee",
    "block.minecraft.potted_brown_mushroom": "Eingedobbdor braunor Bilz",
    "block.minecraft.potted_cactus": "Eingedobbdor Gaggdus",
    "block.minecraft.potted_cornflower": "Eingedobbde Gornblume",
    "block.minecraft.potted_crimson_fungus": "Eengedopfter Garmesinpilz",
    "block.minecraft.potted_crimson_roots": "Eengedopfter Garmesinworzeln",
    "block.minecraft.potted_dandelion": "Eingedobbdor Leewnzahn",
    "block.minecraft.potted_dark_oak_sapling": "Eingedobbdor Schworzeeschnseddsling",
    "block.minecraft.potted_dead_bush": "Eingedobbdor todor Busch",
    "block.minecraft.potted_fern": "Eingedobbdor Farn",
    "block.minecraft.potted_jungle_sapling": "Eingedobbdor Drobnseddsling",
    "block.minecraft.potted_lily_of_the_valley": "Eingedobbdes Maiglöggschn",
    "block.minecraft.potted_oak_sapling": "Eingedobbdor Eeschnseddsling",
    "block.minecraft.potted_orange_tulip": "Eingedobbde orangsche Dulbe",
    "block.minecraft.potted_oxeye_daisy": "Eingedobbdor Margoride",
    "block.minecraft.potted_pink_tulip": "Eingedobbde pinge Dulbe",
    "block.minecraft.potted_poppy": "Eingedobbdor Mohn",
    "block.minecraft.potted_red_mushroom": "Eingedobbdor rodor Bilz",
    "block.minecraft.potted_red_tulip": "Eingedobbde rode Dulbe",
    "block.minecraft.potted_spruce_sapling": "Eingedobbdor Fischdnseddsling",
    "block.minecraft.potted_warped_fungus": "Eengedopfter Wörrpilz",
    "block.minecraft.potted_warped_roots": "Eengedopfter Wirrworzeln",
    "block.minecraft.potted_white_tulip": "Eingedobbde weeße Dulbe",
    "block.minecraft.potted_wither_rose": "Eingedobbde Witherrose",
    "block.minecraft.powered_rail": "Andriebsschiene",
    "block.minecraft.prismarine": "Prismarin",
    "block.minecraft.prismarine_brick_slab": "Prismarinzieschlschdufe",
    "block.minecraft.prismarine_brick_stairs": "Brismarinziescheldrebbe",
    "block.minecraft.prismarine_bricks": "Prismarinzieschl",
    "block.minecraft.prismarine_slab": "Prismarinschdufe",
    "block.minecraft.prismarine_stairs": "Brismarindrebbe",
    "block.minecraft.prismarine_wall": "Prismarinmauer",
    "block.minecraft.pumpkin": "Gärbs",
    "block.minecraft.pumpkin_stem": "Gürbispflanze",
    "block.minecraft.purple_banner": "Lila Bannor",
    ...
    "block.minecraft.purple_shulker_box": "Lila Shulkergissde",
    ...
    "block.minecraft.purpur_block": "Burburblogg",
    "block.minecraft.purpur_pillar": "Burbursäule",
    "block.minecraft.purpur_slab": "Burburschdufe",
    "block.minecraft.purpur_stairs": "Burburdrebbe",
    "block.minecraft.quartz_block": "Quarzblogg",
    "block.minecraft.quartz_bricks": "Quarzzieschel",
    ...
    "block.minecraft.red_banner": "Rodes Bannor",
    "block.minecraft.red_bed": "Rodes Bädde",
    "block.minecraft.red_carpet": "Roodor Täppsch",
    ...
    "block.minecraft.red_mushroom": "Rodor Bilz",
    "block.minecraft.red_mushroom_block": "Rodor Bilzblogg",
    "block.minecraft.red_nether_brick_slab": "Rodde Netherzieschlschtufe",
    "block.minecraft.red_nether_brick_stairs": "Rodde Netherzieschltrebbe",
    "block.minecraft.red_nether_brick_wall": "Rodde Netherzieschlmauer",
    "block.minecraft.red_nether_bricks": "Rode Netherzieschl",
    "block.minecraft.red_sand": "Roder Sand",
    "block.minecraft.red_sandstone": "Roter Sandschdeen",
    "block.minecraft.red_sandstone_slab": "Rode Sandschdeenschdufe",
    "block.minecraft.red_sandstone_stairs": "Rode Sandsteendrebbe",
    "block.minecraft.red_sandstone_wall": "Rodde Sandschdeenmauor",
    "block.minecraft.red_shulker_box": "Rode Shulkergissde",
    ...
    "block.minecraft.repeating_command_block": "Wiedorhol-Befählsblogg",
    "block.minecraft.respawn_anchor": "Seelenangor",
    ...
    "block.minecraft.sandstone_stairs": "Sandsteendrebbe",
    "block.minecraft.sandstone_wall": "Sandschdeenmauor",
    "block.minecraft.scaffolding": "Gerüschd",
    "block.minecraft.sea_lantern": "Seeladerne",
    "block.minecraft.sea_pickle": "Seegurke",
    "block.minecraft.seagrass": "Seegras",
    "block.minecraft.set_spawn": "Wiedoreenschdiegsbungd gesedzd",
    "block.minecraft.shroomlight": "Pilzlischt",
    "block.minecraft.shulker_box": "Shulkergissde",
    "block.minecraft.skeleton_skull": "Schgeleddgobb",
    "block.minecraft.skeleton_wall_skull": "Schgeledd-Wandgobb",
    "block.minecraft.slime_block": "Schleemblogg",
    "block.minecraft.smithing_table": "Schmiedetüsch",
    "block.minecraft.smoker": "Räuschoroofn",
    "block.minecraft.smooth_quartz": "Glatter Quarzblock",
    "block.minecraft.smooth_quartz_slab": "Gladde Quarzschtufe",
    "block.minecraft.smooth_quartz_stairs": "Gladde Quarztrebbe",
    "block.minecraft.smooth_red_sandstone": "Gladdor rodor Sandschdeen",
    ...
    "block.minecraft.smooth_sandstone": "Gladdor Sandschdeen",
    ...
    "block.minecraft.smooth_stone": "Gladdor Schdeen",
    "block.minecraft.smooth_stone_slab": "Gladde Schdeenschtufe",
    "block.minecraft.snow": "Schnee",
    "block.minecraft.snow_block": "Schneeblogg",
    "block.minecraft.soul_campfire": "Seelnlagorfeuor",
    "block.minecraft.soul_fire": "Seelnfeuor",
    "block.minecraft.soul_lantern": "Seelnladderne",
    "block.minecraft.soul_sand": "Seelensand",
    "block.minecraft.soul_soil": "Seelenerde",
    "block.minecraft.soul_torch": "Seelenfaggl",
    "block.minecraft.soul_wall_torch": "Seelenwandfaggl",
    "block.minecraft.spawn.not_valid": "Du hast keen Bett und keen uffgeladenen Seelenangor oder dein Wiedereinstiegspunkt wurde blockiert",
    "block.minecraft.spawner": "Schpawner",
    ...
    "block.minecraft.spruce_fence_gate": "Fischdnhulzzaundor",
    ...
    "block.minecraft.spruce_sign": "Fischdnhulzschild",
    ...
    "block.minecraft.spruce_wall_sign": "Fischdnhulzwandschild",
    "block.minecraft.spruce_wood": "Fischdnhulz",
    "block.minecraft.sticky_piston": "Gläbrigor Golbn",
    ...
    "block.minecraft.stone_bricks": "Schdeenziegel",
    "block.minecraft.stone_button": "Schdeengnopp",
    "block.minecraft.stone_pressure_plate": "Steendrugbladde",
    ...
    "block.minecraft.stripped_acacia_log": "Endrindedor Akazienschdamm",
    "block.minecraft.stripped_acacia_wood": "Endrindedes Akazienholz",
    "block.minecraft.stripped_birch_log": "Endrindedor Bürschnschdamm",
    "block.minecraft.stripped_birch_wood": "Endrindedes Bürschnholz",
    "block.minecraft.stripped_crimson_hyphae": "Geschälder Garmesinhyphen",
    "block.minecraft.stripped_crimson_stem": "Geschälder Garmesinstiel",
    "block.minecraft.stripped_dark_oak_log": "Endrindedor Schwarzeischnschdamm",
    "block.minecraft.stripped_dark_oak_wood": "Endrindedes Schwarzeischnholz",
    "block.minecraft.stripped_jungle_log": "Endrindedor Drobnschdamm",
    "block.minecraft.stripped_jungle_wood": "Endrindedes Drobnholz",
    "block.minecraft.stripped_oak_log": "Endrindedor Eischnschdamm",
    "block.minecraft.stripped_oak_wood": "Endrindedes Eischnholz",
    "block.minecraft.stripped_spruce_log": "Endrindedor Fischdnschdamm",
    "block.minecraft.stripped_spruce_wood": "Endrindedes Fischdnholz",
    "block.minecraft.stripped_warped_hyphae": "Geschälder Wörrhyphen",
    "block.minecraft.stripped_warped_stem": "Geschälder Wörrstiel",
    "block.minecraft.structure_block": "Gonsdrugtionsblogg",
    "block.minecraft.structure_void": "Gonsdrugtionsleere",
    "block.minecraft.sugar_cane": "Zuggorrohr",
    ...
    "block.minecraft.tube_coral": "Orschelgoralle",
    "block.minecraft.tube_coral_block": "Orschelgorallenblogg",
    "block.minecraft.tube_coral_fan": "Orschelgorallenfäschor",
    "block.minecraft.tube_coral_wall_fan": "Orschelgorallenwandfäschor",
    "block.minecraft.turtle_egg": "Schüldgrödnei",
    "block.minecraft.twisting_vines": "Zwörbelrangn",
    "block.minecraft.twisting_vines_plant": "Zwörbelrangnpflanze",
    "block.minecraft.vine": "Rangn",
    "block.minecraft.void_air": "Leernlufd",
    "block.minecraft.wall_torch": "Wandfaggl",
    "block.minecraft.warped_button": "Wörrgnopp",
    "block.minecraft.warped_door": "Wörrdür",
    "block.minecraft.warped_fence": "Wörrzaun",
    "block.minecraft.warped_fence_gate": "Wörrzaundor",
    "block.minecraft.warped_fungus": "Wörrpilz",
    "block.minecraft.warped_hyphae": "Wörrhyphen",
    "block.minecraft.warped_nylium": "Wörr-Nätzel",
    "block.minecraft.warped_planks": "Wörrbredder",
    "block.minecraft.warped_pressure_plate": "Wörrdrugbladde",
    "block.minecraft.warped_roots": "Wörrwurzeln",
    "block.minecraft.warped_sign": "Wörrschild",
    "block.minecraft.warped_slab": "Wörrschdufe",
    "block.minecraft.warped_stairs": "Wörrdrebbe",
    "block.minecraft.warped_stem": "Wörrstiel",
    "block.minecraft.warped_trapdoor": "Wörrfalldür",
    "block.minecraft.warped_wall_sign": "Wörrwandschild",
    "block.minecraft.warped_wart_block": "Wörrworzenblogg",
    "block.minecraft.water": "Wasser",
    "block.minecraft.weeping_vines": "Drauerrangn",
    "block.minecraft.weeping_vines_plant": "Drauerrangnpflanze",
    "block.minecraft.wet_sponge": "Nassor Schwamm",
    "block.minecraft.wheat": "Weezenpflanze",
    "block.minecraft.white_banner": "Weeßes Bannor",
    ...
    "block.minecraft.white_shulker_box": "Weeße Shulkergissde",
    ...
    "block.minecraft.wither_skeleton_skull": "Witherschgeleddgobb",
    "block.minecraft.wither_skeleton_wall_skull": "Witherschgeledd-Wandnischl",
    "block.minecraft.yellow_banner": "Gelbes Bannor",
    "block.minecraft.yellow_bed": "Gelbes Bädde",
    "block.minecraft.yellow_carpet": "Gelbor Täppsch",
    ...
    "block.minecraft.yellow_shulker_box": "Gelbe Shulkergissde",
    ...
    "item.minecraft.acacia_boat": "Agazienhulzboot",
    "item.minecraft.apple": "Abbl",
    "item.minecraft.armor_stand": "Rüsdungsschdändor",
    "item.minecraft.arrow": "Pfeil",
    "item.minecraft.baked_potato": "Ofngardoffl",
    "item.minecraft.bat_spawn_egg": "Flädormaus-Spawn-Ei",
    "item.minecraft.bee_spawn_egg": "Bienen-Schborn-Ei",
    ...
    "item.minecraft.birch_boat": "Bürschnhulzboot",
    "item.minecraft.black_dye": "Schworzorr Farbschdoff",
    "item.minecraft.blaze_powder": "Lohenstoob",
    "item.minecraft.blaze_rod": "Lohenrude",
    "item.minecraft.blaze_spawn_egg": "Lohän-Spawn-Ei",
    ...
    "item.minecraft.cat_spawn_egg": "Miedzn-Spawn-Ei",
    "item.minecraft.cauldron": "Dobb",
    "item.minecraft.cave_spider_spawn_egg": "Höhlnschbinnen-Spawn-Ei",
    ...
    "item.minecraft.charcoal": "Holzgohle",
    ...
    "item.minecraft.clay_ball": "Tonglumpen",
    ...
    "item.minecraft.cod_spawn_egg": "Kabljau-Spawn-Ei",
    ...
    "item.minecraft.cooked_porkchop": "Gebradnes Schweinefleesch",
    ...
    "item.minecraft.creeper_banner_pattern": "Bannorvorlache",
    ...
    "item.minecraft.dark_oak_boat": "Schworzeischnhulzboot",
    "item.minecraft.debug_stick": "Debug-Schdogg",
    "item.minecraft.debug_stick.empty": "%s hat keene Bloggzuschdände",
    "item.minecraft.debug_stick.select": "‚%s‘ ausgwählt (%s)",
    "item.minecraft.debug_stick.update": "‚%s‘ is jäddse %s",
    "item.minecraft.diamond": "Diamand",
    "item.minecraft.diamond_axe": "Diamandaxd",
    "item.minecraft.diamond_boots": "Diamandlaadschn",
    "item.minecraft.diamond_chestplate": "Diamandharnüsch",
    "item.minecraft.diamond_helmet": "Diamandhelm",
    "item.minecraft.diamond_hoe": "Diamandhagge",
    "item.minecraft.diamond_horse_armor": "Diamandnor Rossharnüsch",
    "item.minecraft.diamond_leggings": "Diamandbeenschudz",
    "item.minecraft.diamond_pickaxe": "Diamandschbidzhagge",
    ...
    "item.minecraft.dried_kelp": "Gedroggnedor Seedang",
    "item.minecraft.drowned_spawn_egg": "Erdrungnen-Schborn-Ei",
    "item.minecraft.egg": "Ei",
    "item.minecraft.elder_guardian_spawn_egg": "Großor-Wäschdor-Spawn-Ei",
    "item.minecraft.elytra": "Elydren",
    "item.minecraft.emerald": "Smaragd",
    "item.minecraft.enchanted_book": "Vorzauborde Schwahrde",
    "item.minecraft.enchanted_golden_apple": "Vorzaubordor goldnor Abbl",
    "item.minecraft.end_crystal": "Endergrisdall",
    "item.minecraft.ender_eye": "Enderooche",
    "item.minecraft.ender_pearl": "Enderberle",
    "item.minecraft.enderman_spawn_egg": "Enderman-Schborn-Ei",
    "item.minecraft.endermite_spawn_egg": "Endermiten-Spawn-Ei",
    "item.minecraft.evoker_spawn_egg": "Magior-Spawn-Ei",
    "item.minecraft.experience_bottle": "Ärfahrungsfläschchn",
    "item.minecraft.feather": "Fädor",
    "item.minecraft.fermented_spider_eye": "Fermendierdes Schbinnooche",
    "item.minecraft.filled_map": "Garrde",
    "item.minecraft.fire_charge": "Feierguchel",
    "item.minecraft.firework_rocket": "Feuorwergsragede",
    "item.minecraft.firework_rocket.flight": "Flugdauor:",
    "item.minecraft.firework_star": "Feuorwergsschdern",
    ...
    "item.minecraft.firework_star.fade_to": "Üborgang zu",
    ...
    "item.minecraft.firework_star.light_blue": "Helblou",
    ...
    "item.minecraft.firework_star.shape.small_ball": "Kleene Kugl",
    ...
    "item.minecraft.flint": "Feuorschdeen",
    "item.minecraft.flint_and_steel": "Feuorzeusch",
    "item.minecraft.flower_banner_pattern": "Bannorvorlache",
    ...
    "item.minecraft.globe_banner_pattern": "Bannorvorlache",
    ...
    "item.minecraft.gold_nugget": "Goldglumben",
    "item.minecraft.golden_apple": "Goldnor Abbl",
    "item.minecraft.golden_axe": "Goldaxd",
    ...
    "item.minecraft.golden_horse_armor": "Goldnor Rossharnüsch",
    "item.minecraft.golden_leggings": "Goldbeenschudz",
    "item.minecraft.golden_pickaxe": "Goldschbidzhagge",
    ...
    "item.minecraft.guardian_spawn_egg": "Wäschdor-Spawn-Ei",
    "item.minecraft.gunpowder": "Schwarzbulvor",
    ...
    "item.minecraft.husk_spawn_egg": "Wüsdnzombie-Spawn-Ei",
    "item.minecraft.ink_sac": "Dindnbeudl",
    "item.minecraft.iron_axe": "Eesenaxt",
    "item.minecraft.iron_boots": "Eesenlaadschn",
    "item.minecraft.iron_chestplate": "Eisnharnüsch",
    "item.minecraft.iron_helmet": "Eisnhelm",
    "item.minecraft.iron_hoe": "Eisnhagge",
    "item.minecraft.iron_horse_armor": "Eisornor Rossharnüsch",
    "item.minecraft.iron_ingot": "Eisnbarrn",
    "item.minecraft.iron_leggings": "Eisnbeenschudz",
    "item.minecraft.iron_nugget": "Eisnglumbn",
    "item.minecraft.iron_pickaxe": "Eesenschbidzhagge",
    "item.minecraft.iron_shovel": "Eesenschibbe",
    "item.minecraft.iron_sword": "Eisnschwerd",
    "item.minecraft.item_frame": "Rahm",
    "item.minecraft.jungle_boat": "Drobnhulzboot",
    ...
    "item.minecraft.leather_horse_armor": "Lädornor Rossharnüsch",
    ...
    "item.minecraft.lingering_potion.effect.awkward": "Seldsamor Vorweildrang",
    "item.minecraft.lingering_potion.effect.empty": "Nisch braubaror Vorweildrang",
    "item.minecraft.lingering_potion.effect.fire_resistance": "Vorweildrang dor Feuorresisdenz",
    "item.minecraft.lingering_potion.effect.harming": "Vorweildrang des Schadns",
    "item.minecraft.lingering_potion.effect.healing": "Vorweildrang dor Heilung",
    "item.minecraft.lingering_potion.effect.invisibility": "Vorweildrang dor Unsischdbarkeed",
    "item.minecraft.lingering_potion.effect.leaping": "Vorweildrang dor Schbrunggrafd",
    "item.minecraft.lingering_potion.effect.levitation": "Vorweildrang dor Schwebegrafd",
    "item.minecraft.lingering_potion.effect.luck": "Vorweildrang des Glüggs",
    "item.minecraft.lingering_potion.effect.mundane": "Gewöhnlischor Vorweildrang",
    "item.minecraft.lingering_potion.effect.night_vision": "Vorweildrang dor Nachdsischd",
    "item.minecraft.lingering_potion.effect.poison": "Vorweildrang dor Vorgifdung",
    "item.minecraft.lingering_potion.effect.regeneration": "Vorweildrang dor Regenoration",
    "item.minecraft.lingering_potion.effect.slow_falling": "Vorweildrang des sanfdn Falls",
    "item.minecraft.lingering_potion.effect.slowness": "Vorweildrang dor Langsamkeed",
    "item.minecraft.lingering_potion.effect.strength": "Vorweildrang dor Schdärge",
    "item.minecraft.lingering_potion.effect.swiftness": "Vorweildrang dor Schnellischkeed",
    "item.minecraft.lingering_potion.effect.thick": "Diggflüss'schor Vorweildrang",
    "item.minecraft.lingering_potion.effect.turtle_master": "Vorweildrang des Schüldgrödnmeisdors",
    "item.minecraft.lingering_potion.effect.water": "Vorrweilnde Wassorrbulle",
    "item.minecraft.lingering_potion.effect.water_breathing": "Vorweildrang dor Undorwassoradmung",
    "item.minecraft.lingering_potion.effect.weakness": "Vorweildrang dor Schwäsche",
    ...
    "item.minecraft.magma_cube_spawn_egg": "Magmawürfl-Spawn-Ei",
    ...
    "item.minecraft.nautilus_shell": "Perlboodschale",
    "item.minecraft.nether_brick": "Netherzieschl",
    "item.minecraft.nether_star": "Netherschdern",
    "item.minecraft.nether_wart": "Nädderworze",
    "item.minecraft.netherite_axe": "Netheritaxd",
    "item.minecraft.netherite_boots": "Netheritladschn",
    "item.minecraft.netherite_chestplate": "Netheritharnüsch",
    "item.minecraft.netherite_helmet": "Netherithälm",
    "item.minecraft.netherite_hoe": "Netherithagge",
    "item.minecraft.netherite_ingot": "Netheritbarrn",
    "item.minecraft.netherite_leggings": "Netheritbeenschutz",
    "item.minecraft.netherite_pickaxe": "Netheritschbitzhagge",
    "item.minecraft.netherite_scrap": "Nädderidschdügge",
    "item.minecraft.netherite_shovel": "Netheritschaufl",
    "item.minecraft.netherite_sword": "Netheritschwerd",
    "item.minecraft.oak_boat": "Eischnhulzboot",
    "item.minecraft.ocelot_spawn_egg": "Ozelod-Spawn-Ei",
    ...
    "item.minecraft.paper": "Babbier",
    "item.minecraft.parrot_spawn_egg": "Papagein-Spawn-Ei",
    "item.minecraft.phantom_membrane": "Phandomhaud",
    "item.minecraft.phantom_spawn_egg": "Phandom-Spawn-Ei",
    "item.minecraft.pig_spawn_egg": "Schweine-Spawn-Ei",
    "item.minecraft.piglin_banner_pattern": "Bannorvorlache",
    ...
    "item.minecraft.pillager_spawn_egg": "Plündoror-Schborn-Ei",
    ...
    "item.minecraft.porkchop": "Rohes Schweinefleesch",
    "item.minecraft.potato": "Gardoffl",
    "item.minecraft.potion": "Trank",
    "item.minecraft.potion.effect.awkward": "Seldsamor Drang",
    "item.minecraft.potion.effect.empty": "Nisch braubaror Drang",
    "item.minecraft.potion.effect.fire_resistance": "Drang dor Feuorresisdenz",
    "item.minecraft.potion.effect.harming": "Drang des Schadens",
    "item.minecraft.potion.effect.healing": "Drang dor Heilung",
    "item.minecraft.potion.effect.invisibility": "Drang dor Unsischdbarkeed",
    "item.minecraft.potion.effect.leaping": "Drang dor Schbrunggrafd",
    "item.minecraft.potion.effect.levitation": "Drang dor Schwebegrafd",
    "item.minecraft.potion.effect.luck": "Drang des Glüggs",
    "item.minecraft.potion.effect.mundane": "Gewähnlischor Drang",
    "item.minecraft.potion.effect.night_vision": "Drang dor Nachdsischd",
    "item.minecraft.potion.effect.poison": "Drang dor Vorgifdung",
    "item.minecraft.potion.effect.regeneration": "Drang dor Regenaration",
    "item.minecraft.potion.effect.slow_falling": "Drang des sanfdn Falls",
    "item.minecraft.potion.effect.slowness": "Drang dor Langsamkeed",
    "item.minecraft.potion.effect.strength": "Drang dor Schdärge",
    "item.minecraft.potion.effect.swiftness": "Drang dor Schnellischkeed",
    "item.minecraft.potion.effect.thick": "Diggflüss'schor Drang",
    "item.minecraft.potion.effect.turtle_master": "Drang des Schüldgrödnmeisdors",
    "item.minecraft.potion.effect.water": "Wassorrbulle",
    "item.minecraft.potion.effect.water_breathing": "Drang dor Undorwassoradmung",
    "item.minecraft.potion.effect.weakness": "Drang dor Schwäsche",
    "item.minecraft.prismarine_crystals": "Prismaringrisdalle",
    "item.minecraft.prismarine_shard": "Prismarinschärm",
    ...
    "item.minecraft.pumpkin_pie": "Gürbiskuchn",
    "item.minecraft.pumpkin_seeds": "Kürbisgerne",
    ...
    "item.minecraft.rabbit_spawn_egg": "Kaninschn-Spawn-Ei",
    "item.minecraft.rabbit_stew": "Garnigglragout",
    "item.minecraft.ravager_spawn_egg": "Vorwüstor-Spawn-Ei",
    "item.minecraft.red_dye": "Rodorr Farbschdoff",
    "item.minecraft.redstone": "Redstone-Schdoob",
    "item.minecraft.rotten_flesh": "Vorgammeldes Fleesch",
    ...
    "item.minecraft.shield.black": "Schworzor Schüld",
    "item.minecraft.shield.blue": "Blauor Schüld",
    "item.minecraft.shield.brown": "Braunor Schüld",
    "item.minecraft.shield.cyan": "Dürgisor Schüld",
    "item.minecraft.shield.gray": "Grauor Schüld",
    "item.minecraft.shield.green": "Grienor Schüld",
    "item.minecraft.shield.light_blue": "Hellblauor Schüld",
    "item.minecraft.shield.light_gray": "Hellgrauor Schüld",
    "item.minecraft.shield.lime": "Hellgrienor Schüld",
    "item.minecraft.shield.magenta": "Magenda Schüld",
    "item.minecraft.shield.orange": "Orangschor Schüld",
    "item.minecraft.shield.pink": "Pingor Schüld",
    "item.minecraft.shield.purple": "Lila Schüld",
    "item.minecraft.shield.red": "Rodor Schüld",
    "item.minecraft.shield.white": "Weeßorr Schüld",
    "item.minecraft.shield.yellow": "Gelbor Schüld",
    "item.minecraft.shulker_shell": "Shulkerschale",
    "item.minecraft.shulker_spawn_egg": "Shulker-Spawn-Ei",
    "item.minecraft.sign": "Signiern",
    "item.minecraft.silverfish_spawn_egg": "Silborfischchen-Spawn-Ei",
    "item.minecraft.skeleton_horse_spawn_egg": "Schgeleddpferd-Spawn-Ei",
    "item.minecraft.skeleton_spawn_egg": "Schgeledd-Spawn-Ei",
    "item.minecraft.skull_banner_pattern": "Bannorvorlache",
    "item.minecraft.skull_banner_pattern.desc": "Nischl",
    "item.minecraft.slime_ball": "Schleemball",
    ...
    "item.minecraft.spider_spawn_egg": "Schbinnen-Spawn-Ei",
    "item.minecraft.splash_potion": "Wurftrank",
    "item.minecraft.splash_potion.effect.awkward": "Seldsamor Wurfdrang",
    "item.minecraft.splash_potion.effect.empty": "Nisch braubaror Wurfdrang",
    "item.minecraft.splash_potion.effect.fire_resistance": "Wurfdrang dor Feuorresisdenz",
    "item.minecraft.splash_potion.effect.harming": "Wurfdrang des Schadens",
    "item.minecraft.splash_potion.effect.healing": "Wurfdrang dor Heilung",
    "item.minecraft.splash_potion.effect.invisibility": "Wurfdrang dor Unsischdbarkeed",
    "item.minecraft.splash_potion.effect.leaping": "Wurfdrang dor Schbrunggrafd",
    "item.minecraft.splash_potion.effect.levitation": "Wurfdrang dor Schwebegrafd",
    "item.minecraft.splash_potion.effect.luck": "Wurfdrang des Glüggs",
    "item.minecraft.splash_potion.effect.mundane": "Gewöhnlischor Wurfdrang",
    "item.minecraft.splash_potion.effect.night_vision": "Wurfdrang dor Nachdsischd",
    "item.minecraft.splash_potion.effect.poison": "Wurfdrang dor Vorgifdung",
    "item.minecraft.splash_potion.effect.regeneration": "Wurfdrang dor Regenoration",
    "item.minecraft.splash_potion.effect.slow_falling": "Wurfdrang des sanfdn Falls",
    "item.minecraft.splash_potion.effect.slowness": "Wurfdrang dor Langsamkeed",
    "item.minecraft.splash_potion.effect.strength": "Wurfdrang dor Schdärge",
    "item.minecraft.splash_potion.effect.swiftness": "Wurfdrang dor Schnellischkeed",
    "item.minecraft.splash_potion.effect.thick": "Diggflüss'schor Wurfdrang",
    ...
    "item.minecraft.splash_potion.effect.water_breathing": "Wurfdrang dor Undorwassoradmung",
    "item.minecraft.splash_potion.effect.weakness": "Wurfdrang dor Schwäsche",
    "item.minecraft.spruce_boat": "Fischdnhulzboot",
    "item.minecraft.squid_spawn_egg": "Tindnfisch-Spawn-Ei",
    "item.minecraft.stick": "Schdogg",
    "item.minecraft.stone_axe": "Schdeenaxd",
    "item.minecraft.stone_hoe": "Schdeenhagge",
    "item.minecraft.stone_pickaxe": "Schdeenschbidzhagge",
    "item.minecraft.stone_shovel": "Schdeenschibbe",
    "item.minecraft.stone_sword": "Schdeenschwerd",
    "item.minecraft.stray_spawn_egg": "Eiswandoror-Spawn-Ei",
    "item.minecraft.strider_spawn_egg": "Schreidor-Spawn-Ei",
    "item.minecraft.string": "Foaden",
    "item.minecraft.sugar": "Zuggor",
    "item.minecraft.suspicious_stew": "Suspekde Subbe",
    "item.minecraft.sweet_berries": "Süßbeern",
    "item.minecraft.tipped_arrow": "Gedrängdor Pfeil",
    "item.minecraft.tipped_arrow.effect.awkward": "Gedrängdor Pfeil",
    "item.minecraft.tipped_arrow.effect.empty": "Nisch herschdellbaror gedrängdor Pfeil",
    "item.minecraft.tipped_arrow.effect.fire_resistance": "Pfeil dor Feuorresisdenz",
    "item.minecraft.tipped_arrow.effect.harming": "Pfeil des Schadns",
    "item.minecraft.tipped_arrow.effect.healing": "Pfeil dor Heilung",
    "item.minecraft.tipped_arrow.effect.invisibility": "Pfeil dor Unsischdbarkeed",
    "item.minecraft.tipped_arrow.effect.leaping": "Pfeil dor Schbrunggrafd",
    "item.minecraft.tipped_arrow.effect.levitation": "Pfeil dor Schwebegrafd",
    "item.minecraft.tipped_arrow.effect.luck": "Pfeil des Glüggs",
    "item.minecraft.tipped_arrow.effect.mundane": "Gedrängdor Pfeil",
    "item.minecraft.tipped_arrow.effect.night_vision": "Pfeil dor Nachdsischd",
    "item.minecraft.tipped_arrow.effect.poison": "Pfeil dor Vorgifdung",
    "item.minecraft.tipped_arrow.effect.regeneration": "Pfeil dor Regenoration",
    "item.minecraft.tipped_arrow.effect.slow_falling": "Pfeil des sanfdn Falls",
    "item.minecraft.tipped_arrow.effect.slowness": "Pfeil dor Langsamkeed",
    "item.minecraft.tipped_arrow.effect.strength": "Pfeil dor Schdärge",
    "item.minecraft.tipped_arrow.effect.swiftness": "Pfeil dor Schnellischkeed",
    "item.minecraft.tipped_arrow.effect.thick": "Gedrängdor Pfeil",
    "item.minecraft.tipped_arrow.effect.turtle_master": "Pfeil des Schüldgrödnmeisdors",
    "item.minecraft.tipped_arrow.effect.water": "Nassor Pfeil",
    "item.minecraft.tipped_arrow.effect.water_breathing": "Pfeil dor Undorwassoradmung",
    "item.minecraft.tipped_arrow.effect.weakness": "Pfeil dor Schwäsche",
    "item.minecraft.tnt_minecart": "TNT-Lore",
    "item.minecraft.totem_of_undying": "Dodem dor Unschderblischkeed",
    ...
    "item.minecraft.tropical_fish_bucket": "Trobnfischehmor",
    "item.minecraft.tropical_fish_spawn_egg": "Trobnfisch-Spawn-Ei",
    "item.minecraft.turtle_helmet": "Schüldgrödnbanzor",
    "item.minecraft.turtle_spawn_egg": "Schildgrödn-Spawn-Ei",
    "item.minecraft.vex_spawn_egg": "Plagegeisdor-Spawn-Ei",
    "item.minecraft.villager_spawn_egg": "Dorfbewohnor-Spawn-Ei",
    "item.minecraft.vindicator_spawn_egg": "Dienor-Spawn-Ei",
    "item.minecraft.wandering_trader_spawn_egg": "Fahrendorr-Händlorr-Schborn-Ei",
    "item.minecraft.warped_fungus_on_a_stick": "Wörrpilzrude",
    "item.minecraft.water_bucket": "Wassorrehmorr",
    "item.minecraft.wheat": "Weizn",
    "item.minecraft.wheat_seeds": "Weizngörnor",
    "item.minecraft.white_dye": "Weeßorr Farbschdoff",
    "item.minecraft.witch_spawn_egg": "Hexn-Schborn-Ei",
    "item.minecraft.wither_skeleton_spawn_egg": "Witherschgeledd-Schborn-Ei",
    "item.minecraft.wolf_spawn_egg": "Wulfs-Schborn-Ei",
    "item.minecraft.wooden_axe": "Hulzaxd",
    "item.minecraft.wooden_hoe": "Hulzhagge",
    "item.minecraft.wooden_pickaxe": "Hulzschbidzhagge",
    "item.minecraft.wooden_shovel": "Hulzschibbe",
    "item.minecraft.wooden_sword": "Hulzschwerd",
    "item.minecraft.writable_book": "Schwahrde un Fädor",
    ...
    "item.minecraft.zombie_horse_spawn_egg": "Zombiefärde-Spawn-Ei",
    "item.minecraft.zombie_spawn_egg": "Zombie-Schborn-Ei",
    "item.minecraft.zombie_villager_spawn_egg": "Zombiedorfbewohnorr-Schborn-Ei",
    "item.minecraft.zombified_piglin_spawn_egg": "Zombifizierdor-Piglin-Schborn-Ei",
}
