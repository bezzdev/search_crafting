var items = {
    ...
    "item.minecraft.debug_stick.select": " sélectionné (%s)",
    "item.minecraft.debug_stick.update": " à %s",
    ...
    "item.minecraft.tipped_arrow.effect.empty": "Flèche trempée non fabricable",
