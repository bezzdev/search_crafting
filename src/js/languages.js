var languages = [
  { name: 'Af-Soomaali', region: 'Soomaaliya', key: 'so_so', localized: 'Somali', warning: null },
  ...
  { name: 'Boarisch', region: 'Bayern', key: 'bar', localized: 'Bavarian', warning: null },
  { name: 'Bosanski', region: 'Bosna i Hercegovina', key: 'bs_ba', localized: 'Bosnian', warning: null },
  { name: 'Brabants', region: 'Nederland', key: 'brb', localized: 'Brabantian', warning: null },
  { name: 'Brezhoneg', region: 'Breizh', key: 'br_fr', localized: 'Breton', warning: null },
  ...
  { name: 'Føroyskt', region: 'Føroyar', key: 'fo_fo', localized: 'Faroese', warning: null },
  ...
  { name: 'Fränggisch', region: 'Franggn', key: 'fra_de', localized: 'Franconian', warning: null },
  ...
  { name: 'Latina', region: 'Latium', key: 'la_la', localized: 'Latin', warning: null },
  ...
  { name: 'Lietuvių', region: 'Lietuva', key: 'lt_lt', localized: 'Lithuanian', warning: null },
  ...
  { name: 'Norsk nynorsk', region: 'Noreg', key: 'nn_no', localized: 'Nynorsk Norwegian', warning: null },
  { name: 'Occitan', region: 'Occitània', key: 'oc_fr', localized: 'Occitan', warning: null },
  { name: 'Oschdallgaiarisch', region: 'Allgai', key: 'swg', localized: 'Allgovian German', warning: null },
  ...
  { name: '简体中文', region: '中国', key: 'zh_cn', localized: 'Simplified Chinese', warning: "Multiple keystrokes may be required to type a single character in this language." },
  { name: '繁體中文', region: '香港', key: 'zh_hk', localized: 'Traditional Chinese', warning: "Multiple keystrokes may be required to type a single character in this language." },
