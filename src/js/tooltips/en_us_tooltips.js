var items = {
  ...
  "item.minecraft.turtle_helmet": "turtle shell□□when on head:□+2 armor",
  ...
  "item.minecraft.leather_helmet": "leather cap□□when on head:□+1 armor",
  "item.minecraft.leather_chestplate": "leather tunic□□when on body:□+3 armor",
  "item.minecraft.leather_leggings": "leather pants□□when on legs:□+2 armor",
  "item.minecraft.leather_boots": "leather boots□□when on feet:□+1 armor",
  "item.minecraft.chainmail_helmet": "chainmail helmet□□when on head:□+2 armor",
  "item.minecraft.chainmail_chestplate": "chainmail chestplate□□when on body:□+5 armor",
  "item.minecraft.chainmail_leggings": "chainmail leggings□□when on legs:□+4 armor",
  "item.minecraft.chainmail_boots": "chainmail boots□□when on feet:□+1 armor",
  "item.minecraft.iron_helmet": "iron helmet□□when on head:□+2 armor",
  "item.minecraft.iron_chestplate": "iron chestplate□□when on body:□+6 armor",
  "item.minecraft.iron_leggings": "iron leggings□□when on legs:□+5 armor",
  "item.minecraft.iron_boots": "iron boots□□when on feet:□+2 armor",
  "item.minecraft.diamond_helmet": "diamond helmet□□when on head:□+3 armor□+2 armor toughness",
  "item.minecraft.diamond_chestplate": "diamond chestplate□□when on body:□+8 armor□+2 armor toughness",
  "item.minecraft.diamond_leggings": "diamond leggings□□when on legs:□+6 armor□+2 armor toughness",
  "item.minecraft.diamond_boots": "diamond boots□□when on feet:□+3 armor□+2 armor toughness",
  "item.minecraft.golden_helmet": "golden helmet□□when on head:□+2 armor",
  "item.minecraft.golden_chestplate": "golden chestplate□□when on body:□+5 armor",
  "item.minecraft.golden_leggings": "golden leggings□□when on legs:□+3 armor",
  "item.minecraft.golden_boots": "golden boots□□when on feet:□+1 armor",
  "item.minecraft.netherite_helmet": "netherite helmet□□when on head:□+3 armor□+3 armor toughness□+1 knockback resistance",
  "item.minecraft.netherite_chestplate": "netherite chestplate□□when on body:□+8 armor□+3 armor toughness□+1 knockback resistance",
  "item.minecraft.netherite_leggings": "netherite leggings□□when on legs:□+6 armor□+3 armor toughness□+1 knockback resistance",
  "item.minecraft.netherite_boots": "netherite boots□□when on feet:□+3 armor□+3 armor toughness□+1 knockback resistance",
