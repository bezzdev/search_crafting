var items = {
    ...
    "block.minecraft.acacia_fence_gate": "Acaciahouten pörtje",
    ...
    "block.minecraft.acacia_stairs": "Acaciahouten traeje",
    "block.minecraft.acacia_trapdoor": "Acacia Valluik",
    "block.minecraft.acacia_wall_sign": "Acaciahouten bord aon moer",
    ...
    "block.minecraft.banner.border.light_gray": "Lichtgrieze zoom",
    "block.minecraft.banner.border.lime": "Lichtgreune zoom",
    ...
    "block.minecraft.banner.bricks.black": "Zjwart veld gemetseld",
    "block.minecraft.banner.bricks.blue": "Blauw veld gemetseld",
    "block.minecraft.banner.bricks.brown": "Broen veld gemetseld",
    "block.minecraft.banner.bricks.cyan": "Turquoise veld gemetseld",
    "block.minecraft.banner.bricks.gray": "Gries veld gemetseld",
    "block.minecraft.banner.bricks.green": "Greun veld gemetseld",
    "block.minecraft.banner.bricks.light_blue": "Lichtblauw veld gemetseld",
    "block.minecraft.banner.bricks.light_gray": "Lichtgries veld gemetseld",
    "block.minecraft.banner.bricks.lime": "Lichtgreun veld gemetseld",
    "block.minecraft.banner.bricks.magenta": "Magenta veld gemetseld",
    "block.minecraft.banner.bricks.orange": "Oranje veld gemetseld",
    "block.minecraft.banner.bricks.pink": "Roze veld gemetseld",
    "block.minecraft.banner.bricks.purple": "Paars veld gemetseld",
    "block.minecraft.banner.bricks.red": "Roed veld gemetseld",
    "block.minecraft.banner.bricks.white": "Wit veld gemetseld",
    "block.minecraft.banner.bricks.yellow": "Gael veld gemetseld",
    ...
    "block.minecraft.banner.circle.light_gray": "Lichtgries rozet",
    "block.minecraft.banner.circle.lime": "Lichtgreun rozet",
    ...
    "block.minecraft.banner.creeper.light_gray": "Lichtgries Creeperwapen",
    "block.minecraft.banner.creeper.lime": "Lichtgreun creeperwapen",
    ...
    "block.minecraft.banner.cross.light_blue": "Licht blauw andreaskroes",
    "block.minecraft.banner.cross.light_gray": "Licht gries andreaskroes",
    "block.minecraft.banner.cross.lime": "Licht greun andreaskroes",
    ...
    "block.minecraft.banner.curly_border.light_gray": "Licht grieze ingesprongen zoom",
    "block.minecraft.banner.curly_border.lime": "Lichtgreune ingesprongen zoom",
    ...
    "block.minecraft.banner.diagonal_left.light_blue": "Lichtblauwe per band omgekeerd",
    "block.minecraft.banner.diagonal_left.light_gray": "Licht grieze per band omgekeerd",
    "block.minecraft.banner.diagonal_left.lime": "Lichtgreune per band sinister",
    ...
    "block.minecraft.banner.diagonal_right.light_gray": "Lichtgrieze per band",
    "block.minecraft.banner.diagonal_right.lime": "Lichtgreune per band",
    ...
    "block.minecraft.banner.diagonal_up_left.light_gray": "Licht grieze per band omgekeerd",
    "block.minecraft.banner.diagonal_up_left.lime": "Lichtgreune per band omgekeerd",
    ...
    "block.minecraft.banner.diagonal_up_right.light_blue": "Lichtblauwe per band sinister omgekeerd",
    "block.minecraft.banner.diagonal_up_right.light_gray": "Lichtgrijze per band sinister omgekeerd",
    "block.minecraft.banner.diagonal_up_right.lime": "Lichtgruene per band sinister omgekeerd",
    ...
    "block.minecraft.banner.flower.light_gray": "Licht gries bloemwapen",
    "block.minecraft.banner.flower.lime": "Lichtgreun bloemwapen",
    ...
    "block.minecraft.banner.globe.light_blue": "Lichte Blauwe Bol",
    "block.minecraft.banner.globe.light_gray": "Lichte Grieze Bol",
    "block.minecraft.banner.globe.lime": "Licht greune globe",
    ...
    "block.minecraft.banner.gradient.light_gray": "Lichtgries gradiënt",
    "block.minecraft.banner.gradient.lime": "Lichtgreun gradiënt",
    ...
    "block.minecraft.banner.gradient_up.light_gray": "Lichtgries basis gradiënt",
    "block.minecraft.banner.gradient_up.lime": "Lichtgreun basis gradiënt",
    ...
    "block.minecraft.banner.half_horizontal.light_gray": "Lichtgrieze per faas",
    "block.minecraft.banner.half_horizontal.lime": "Lichtgreune per faas",
    ...
    "block.minecraft.banner.half_horizontal_bottom.lime": "Lichtgreune per faas omgekeerd",
    ...
    "block.minecraft.banner.half_vertical.light_blue": "Lichtblauwe per päöl",
    "block.minecraft.banner.half_vertical.light_gray": "Lichtgrieze per päöl",
    "block.minecraft.banner.half_vertical.lime": "Lichtgreune per päöl",
    ...
    "block.minecraft.banner.half_vertical_right.light_blue": "Lichtblauwe per päöl omgekeerd",
    "block.minecraft.banner.half_vertical_right.light_gray": "Licht grieze per päöl omgekeerd",
    "block.minecraft.banner.half_vertical_right.lime": "Lichtgreune per päöl omgekeerd",
    ...
    "block.minecraft.banner.mojang.light_gray": "Lightgries Mojangwapen",
    "block.minecraft.banner.mojang.lime": "Lichtgreun Mojangwapen",
    ...
    "block.minecraft.banner.piglin.light_blue": "Licht blauwe snoet",
    "block.minecraft.banner.piglin.light_gray": "Licht grieze snoet",
    "block.minecraft.banner.piglin.lime": "Limoen snoet",
    ...
    "block.minecraft.banner.rhombus.light_blue": "Lichtblauwe roet",
    "block.minecraft.banner.rhombus.light_gray": "Lichtgrieze roet",
    "block.minecraft.banner.rhombus.lime": "Lichtgreune roet",
    ...
    "block.minecraft.banner.skull.light_gray": "Lichtgries schedelwapen",
    "block.minecraft.banner.skull.lime": "Licht greun schedelwapen",
    ...
    "block.minecraft.banner.small_stripes.light_blue": "Lichtblauwe paly",
    "block.minecraft.banner.small_stripes.light_gray": "Licht grieze paly",
    "block.minecraft.banner.small_stripes.lime": "Lichtgreune paly",
    ...
    "block.minecraft.banner.square_bottom_left.light_blue": "Lichtblauw basis dexter kanton",
    "block.minecraft.banner.square_bottom_left.light_gray": "Licht gries basis dexter kanton",
    "block.minecraft.banner.square_bottom_left.lime": "Lichtgreun basis dexter kanton",
    ...
    "block.minecraft.banner.square_bottom_right.light_blue": "Licht Blauw Basis Sinister Kanton",
    "block.minecraft.banner.square_bottom_right.light_gray": "Licht Gries Basis Sinister Kanton",
    "block.minecraft.banner.square_bottom_right.lime": "Lichtgreun basis sinister kanton",
    ...
    "block.minecraft.banner.square_top_left.light_gray": "Licht gries hoofd dexter kanton",
    "block.minecraft.banner.square_top_left.lime": "Lichtgreun hoofd dexter kanton",
    ...
    "block.minecraft.banner.square_top_right.light_blue": "Licht Blauw Hoofd Sinister Kanton",
    "block.minecraft.banner.square_top_right.light_gray": "Licht Gries Hoofd Sinister Kanton",
    "block.minecraft.banner.square_top_right.lime": "Lichtgreun hoofd sinister kanton",
    ...
    "block.minecraft.banner.straight_cross.light_blue": "Lichtblauw kroes",
    "block.minecraft.banner.straight_cross.light_gray": "Licht gries kroes",
    "block.minecraft.banner.straight_cross.lime": "Lichtgreun kroes",
    ...
    "block.minecraft.banner.stripe_bottom.light_blue": "Licht blauwe basis",
    "block.minecraft.banner.stripe_bottom.light_gray": "Licht grieze basis",
    "block.minecraft.banner.stripe_bottom.lime": "Licht greune basis",
    ...
    "block.minecraft.banner.stripe_center.light_blue": "Licht blauwe päöl",
    "block.minecraft.banner.stripe_center.light_gray": "Licht Grieze päöl",
    "block.minecraft.banner.stripe_center.lime": "Licht greune päöl",
    ...
    "block.minecraft.banner.stripe_downleft.light_blue": "Lichtblauwe band sinister",
    "block.minecraft.banner.stripe_downleft.light_gray": "Lichtgrieze band sinister",
    "block.minecraft.banner.stripe_downleft.lime": "Lichtgreune band sinister",
    ...
    "block.minecraft.banner.stripe_downright.light_blue": "Lichtblauwe band",
    "block.minecraft.banner.stripe_downright.light_gray": "Lichtgrieze band",
    "block.minecraft.banner.stripe_downright.lime": "Lichtgreune band",
    ...
    "block.minecraft.banner.stripe_left.light_blue": "Licht blauwe päöl dexter",
    "block.minecraft.banner.stripe_left.light_gray": "Licht grieze päöl dexter",
    "block.minecraft.banner.stripe_left.lime": "Licht greune päöl dexter",
    ...
    "block.minecraft.banner.stripe_middle.light_gray": "Lichtgrieze faas",
    "block.minecraft.banner.stripe_middle.lime": "Lichtgreune faas",
    ...
    "block.minecraft.banner.stripe_right.light_blue": "Lichtblauwe päöl sinister",
    "block.minecraft.banner.stripe_right.light_gray": "Lichtgrieze päöl sinister",
    "block.minecraft.banner.stripe_right.lime": "Lichtgreune päöl sinister",
    ...
    "block.minecraft.banner.stripe_top.light_gray": "Lichtgrieze top",
    "block.minecraft.banner.stripe_top.lime": "Lichtgreune top",
    ...
    "block.minecraft.banner.triangle_bottom.light_gray": "Lichtgrieze keper",
    "block.minecraft.banner.triangle_bottom.lime": "Lichtgreune keper",
    ...
    "block.minecraft.banner.triangle_top.light_gray": "Licht grieze omgekeerde keper",
    "block.minecraft.banner.triangle_top.lime": "Lichtgreune omgekeerde keper",
    ...
    "block.minecraft.banner.triangles_bottom.light_gray": "Lichtgrieze ingesprongen basis",
    "block.minecraft.banner.triangles_bottom.lime": "Lichtgreune ingesprongen basis",
    ...
    "block.minecraft.banner.triangles_top.light_gray": "Lichtgries ingesprongen hoofd",
    "block.minecraft.banner.triangles_top.lime": "Lichtgreun ingesprongen hoofd",
    ...
    "block.minecraft.birch_fence_gate": "Berkenhouten pörtje",
    ...
    "block.minecraft.birch_stairs": "Berkehoute Trap",
    "block.minecraft.birch_trapdoor": "Berkehoute Valluik",
    "block.minecraft.birch_wall_sign": "Berkenhouten bord aon moer",
    ...
    "block.minecraft.black_shulker_box": "Zjwarte Shulker doeas",
    ...
    "block.minecraft.blackstone_stairs": "Zwartstein trap",
    ...
    "block.minecraft.blue_shulker_box": "Blauwe Shulker doeas",
    ...
    "block.minecraft.brick_slab": "Bakstjeinen plaat",
    "block.minecraft.brick_stairs": "Baksjteinen trap",
    "block.minecraft.brick_wall": "Baksjteinen moer",
    "block.minecraft.bricks": "Baksjteinen",
    ...
    "block.minecraft.brown_shulker_box": "Broene Shulker doeas",
    ...
    "block.minecraft.chain": "Gekoppeld",
    "block.minecraft.chain_command_block": "Kèttingopdrachblok",
    ...
    "block.minecraft.chiseled_red_sandstone": "Verseerde Roeje Zandjsjtein",
    "block.minecraft.chiseled_sandstone": "Verseerd Zandjsjtein",
    "block.minecraft.chiseled_stone_bricks": "Gebeitelde bloksjteinen",
    ...
    "block.minecraft.cobblestone_stairs": "Sjteinen trap",
    "block.minecraft.cobblestone_wall": "Keijmoer",
    ...
    "block.minecraft.cracked_stone_bricks": "Gebarste bloksjteinen",
    "block.minecraft.crafting_table": "Werkbank",
    "block.minecraft.creeper_head": "Creeperhoofd",
    "block.minecraft.creeper_wall_head": "Creeperhoofd aon moer",
    "block.minecraft.crimson_button": "Karmozienroede houten knöp",
    "block.minecraft.crimson_door": "Karmozienroede deur",
    "block.minecraft.crimson_fence": "Karmozienroede houten hek",
    "block.minecraft.crimson_fence_gate": "Karmozienroede houten peurtje",
    "block.minecraft.crimson_fungus": "Karmozienroede zwam",
    "block.minecraft.crimson_hyphae": "Karmozienroed schimmeldraod",
    "block.minecraft.crimson_nylium": "Karmozienroed nylium",
    "block.minecraft.crimson_planks": "Kormozienroede houten plenk",
    "block.minecraft.crimson_pressure_plate": "Karmzienroede houten drukplaat",
    "block.minecraft.crimson_roots": "Karmozienroede wortelle",
    "block.minecraft.crimson_sign": "Karmozienroed houten bord",
    "block.minecraft.crimson_slab": "Karmozienrode houten plaat",
    "block.minecraft.crimson_stairs": "Karmozienroede houten trap",
    "block.minecraft.crimson_stem": "Karmozienroed stem",
    "block.minecraft.crimson_trapdoor": "Karmozienroede houten valloek",
    "block.minecraft.crimson_wall_sign": "Karmozienroed bord aan moor",
    "block.minecraft.crying_obsidian": "Huilend obsidiaan",
    "block.minecraft.cut_red_sandstone": "Gesnjeden roed zandsteen",
    "block.minecraft.cut_red_sandstone_slab": "Gesneeje Roeje Zandjsjteine Plaat",
    "block.minecraft.cut_sandstone": "Gesnjeden zandstjein",
    "block.minecraft.cut_sandstone_slab": "Gesneeje Zandjsjteine Plaat",
    ...
    "block.minecraft.cyan_shulker_box": "Turquoise Shulker doeas",
    ...
    "block.minecraft.dark_oak_fence_gate": "Donkere eikenhouten pörtje",
    ...
    "block.minecraft.dark_oak_stairs": "Donkere Eikehoute trap",
    "block.minecraft.dark_oak_trapdoor": "Dónkere eikenhouten duur",
    "block.minecraft.dark_oak_wall_sign": "Donkereikenhouten bord aon moer",
    ...
    "block.minecraft.dark_prismarine_stairs": "Donkere Prismarine Trap",
    "block.minecraft.daylight_detector": "Daagleeg sensor",
    ...
    "block.minecraft.end_stone": "Endsjtein",
    "block.minecraft.end_stone_brick_slab": "Endbloksjteinen plaat",
    "block.minecraft.end_stone_brick_stairs": "Endbloksjteinen trap",
    "block.minecraft.end_stone_brick_wall": "Endbloksjteinen moer",
    "block.minecraft.end_stone_bricks": "Endbloksjteinen",
    ...
    "block.minecraft.glowstone": "Gloeisjtein",
    ...
    "block.minecraft.gray_shulker_box": "Gries Shulker Doeas",
    ...
    "block.minecraft.green_shulker_box": "Greune Shulker doeas",
    ...
    "block.minecraft.infested_chiseled_stone_bricks": "Geïnfecteerde gesjleepe bakstein",
    "block.minecraft.infested_cobblestone": "Geïnfecteerde kiezelsjtein",
    "block.minecraft.infested_cracked_stone_bricks": "Geïnfecteerde gebröake baksjtein",
    "block.minecraft.infested_mossy_stone_bricks": "Geïnfecteerde mossige baksjtein",
    "block.minecraft.infested_stone": "Geïnfecteerde sjtein",
    "block.minecraft.infested_stone_bricks": "Geïnfecteerde baksjtein blok",
    ...
    "block.minecraft.jungle_fence_gate": "Oerwoudhouten pörtje",
    ...
    "block.minecraft.jungle_stairs": "Oerwoudhouten traeje",
    "block.minecraft.jungle_trapdoor": "Oerwoud valluik",
    "block.minecraft.jungle_wall_sign": "Oerwoudhouten bord aon moer",
    ...
    "block.minecraft.large_fern": "Groeate varen",
    "block.minecraft.lava": "Lava",
    "block.minecraft.lectern": "Lessenaar",
    "block.minecraft.lever": "Hendel",
    "block.minecraft.light_blue_banner": "Licht blauwe banier",
    "block.minecraft.light_blue_bed": "Licht blauw bèd",
    "block.minecraft.light_blue_carpet": "Lichblauw Kerpèt",
    ...
    "block.minecraft.light_blue_shulker_box": "Licht blauwe Shulker doeas",
    "block.minecraft.light_blue_stained_glass": "Licht blauw gekleurd glaas",
    "block.minecraft.light_blue_stained_glass_pane": "Licht blauw gekleurde glazen roet",
    "block.minecraft.light_blue_terracotta": "Lichtblauwe Terracotta",
    "block.minecraft.light_blue_wool": "Licht blauwe wol",
    "block.minecraft.light_gray_banner": "Licht grieze banier",
    "block.minecraft.light_gray_bed": "Licht gries bèd",
    "block.minecraft.light_gray_carpet": "Lichgries Kerpèt",
    "block.minecraft.light_gray_concrete": "Lichtgries beton",
    "block.minecraft.light_gray_concrete_powder": "Lichtgries cement",
    "block.minecraft.light_gray_glazed_terracotta": "Lichtgriesgeglazuurde terracotta",
    "block.minecraft.light_gray_shulker_box": "Licht Grieze Shulker Doeas",
    "block.minecraft.light_gray_stained_glass": "Licht gries gekleurd glaas",
    "block.minecraft.light_gray_stained_glass_pane": "Licht gries gekleurde glazen roet",
    "block.minecraft.light_gray_terracotta": "Lichtgriese Terracotta",
    "block.minecraft.light_gray_wool": "Licht grieze Wol",
    ...
    "block.minecraft.lime_banner": "Lichtgreune banier",
    "block.minecraft.lime_bed": "Licht greun bèd",
    "block.minecraft.lime_carpet": "Lichgreun Kerpèt",
    "block.minecraft.lime_concrete": "Lichtgreun beton",
    "block.minecraft.lime_concrete_powder": "Lichtgreun cement",
    "block.minecraft.lime_glazed_terracotta": "Lichtgreungeglazuurde terracotta",
    "block.minecraft.lime_shulker_box": "Ligt Greune Shulker Doeas",
    "block.minecraft.lime_stained_glass": "Licht greun gekleurd glaas",
    "block.minecraft.lime_stained_glass_pane": "Licht greun gekleurde glazen roet",
    "block.minecraft.lime_terracotta": "Lichtgreune terracotta",
    "block.minecraft.lime_wool": "Lichgreune wol",
    ...
    "block.minecraft.magenta_shulker_box": "Magenta Shulker doeas",
    ...
    "block.minecraft.mossy_cobblestone": "Mossige keisjtein",
    "block.minecraft.mossy_cobblestone_slab": "Mossige keisjteinen plaat",
    "block.minecraft.mossy_cobblestone_stairs": "Mossige keisjteinen trap",
    "block.minecraft.mossy_cobblestone_wall": "Mossige Keijmoer",
    "block.minecraft.mossy_stone_brick_slab": "Mossige bloksjteinen plaat",
    "block.minecraft.mossy_stone_brick_stairs": "Mossige bloksjteinen trap",
    "block.minecraft.mossy_stone_brick_wall": "Mossige bloksjteinen moer",
    "block.minecraft.mossy_stone_bricks": "Mossige bloksjteinen",
    ...
    "block.minecraft.nether_brick_fence": "Netherbaksjteinen hek",
    "block.minecraft.nether_brick_slab": "Netherbaksjteinen plaat",
    "block.minecraft.nether_brick_stairs": "Netherbaksjteinen trap",
    "block.minecraft.nether_brick_wall": "Netherbaksjteinen moer",
    "block.minecraft.nether_bricks": "Nether Baksjtein",
    ...
    "block.minecraft.oak_fence_gate": "Eikenhouten pörtje",
    ...
    "block.minecraft.oak_stairs": "Eikehoute Trap",
    "block.minecraft.oak_trapdoor": "Eikhoute valluik",
    "block.minecraft.oak_wall_sign": "Eikenhouten bord aon moer",
    ...
    "block.minecraft.orange_shulker_box": "Oranje Shulker doeas",
    ...
    "block.minecraft.pink_shulker_box": "Roze Shulker doeas",
    ...
    "block.minecraft.polished_andesite_stairs": "Gepolieste andesiettrap",
    ...
    "block.minecraft.polished_blackstone_brick_stairs": "Gepolieste zwartstein bakstein trap",
    ...
    "block.minecraft.polished_blackstone_stairs": "Gepolieste zwartstein trap",
    ...
    "block.minecraft.polished_diorite_stairs": "Gepolieste dioriettrap",
    "block.minecraft.polished_granite": "Gepolijste Graniet",
    "block.minecraft.polished_granite_slab": "Gepolieste granietplaat",
    "block.minecraft.polished_granite_stairs": "Gepolieste graniettrap",
    ...
    "block.minecraft.potted_crimson_fungus": "Opgepotte karmozienroede zwam",
    "block.minecraft.potted_crimson_roots": "Opgepotte karmozienroede wortelle",
    ...
    "block.minecraft.prismarine_brick_slab": "Prismarienbloksjteinen plaat",
    "block.minecraft.prismarine_brick_stairs": "Prismarienbloksjteinen trap",
    "block.minecraft.prismarine_bricks": "Prismarine bloksjteinen",
    "block.minecraft.prismarine_slab": "Prismarine Plaat",
    "block.minecraft.prismarine_stairs": "Prismarine Trap",
    ...
    "block.minecraft.purple_shulker_box": "Paarse Shulker doeas",
    ...
    "block.minecraft.purpur_pillar": "Purpurpelaer",
    ...
    "block.minecraft.red_nether_brick_slab": "Roede Netherbaksjteinen plaat",
    "block.minecraft.red_nether_brick_stairs": "Roede Netherbaksjteinen trap",
    "block.minecraft.red_nether_brick_wall": "Roede Netherbaksjteinen moer",
    "block.minecraft.red_nether_bricks": "Roeje Nether baksjtein",
    "block.minecraft.red_sand": "Roed Zandj",
    "block.minecraft.red_sandstone": "Roeje Zandjsjtein",
    "block.minecraft.red_sandstone_slab": "Roeje Zandjsjteine Plaat",
    "block.minecraft.red_sandstone_stairs": "Roeje Zandjsjteinen Trap",
    "block.minecraft.red_sandstone_wall": "Roede zandsjteinen moer",
    "block.minecraft.red_shulker_box": "Roeje Shulker doeas",
    ...
    "block.minecraft.redstone_wall_torch": "Redstone Moer Fakkel",
    ...
    "block.minecraft.sandstone": "Zandjsjtein",
    "block.minecraft.sandstone_slab": "Zandjsjteine Plaat",
    "block.minecraft.sandstone_stairs": "Zandjsjteinen Trap",
    ...
    "block.minecraft.sea_pickle": "Zee Augurk",
    "block.minecraft.seagrass": "Ziegraas",
    "block.minecraft.set_spawn": "Herspawn punt gezatte",
    "block.minecraft.shroomlight": "Zwammenleecht",
    "block.minecraft.shulker_box": "Shulker doeas",
    ...
    "block.minecraft.smooth_red_sandstone": "Glate Roeje Zandjsjtein",
    "block.minecraft.smooth_red_sandstone_slab": "Gladde roede zandsjteinen plaat",
    "block.minecraft.smooth_red_sandstone_stairs": "Gladde roede zandsjteinen trap",
    "block.minecraft.smooth_sandstone": "Glaat Zandjsjtein",
    "block.minecraft.smooth_sandstone_slab": "Gladde zandsjteinen plaat",
    "block.minecraft.smooth_sandstone_stairs": "Gladde zandsjteinen trap",
    "block.minecraft.smooth_stone": "Gladde stjeen",
    "block.minecraft.smooth_stone_slab": "Gladde sjteinen plaat",
    ...
    "block.minecraft.spruce_door": "Sjparrehoute duuer",
    "block.minecraft.spruce_fence": "Sparrenhouten hek",
    "block.minecraft.spruce_fence_gate": "Sparrenhouten pörtje",
    ...
    "block.minecraft.spruce_stairs": "Sparrenhouten traeje",
    "block.minecraft.spruce_trapdoor": "Sjparhoute valluik",
    "block.minecraft.spruce_wall_sign": "Sjparrenhoutenbord aon moer",
    "block.minecraft.spruce_wood": "Sjparrehout",
    "block.minecraft.sticky_piston": "Kleefzuiger",
    "block.minecraft.stone": "Sjtein",
    "block.minecraft.stone_brick_slab": "Bloksjteinen plaat",
    "block.minecraft.stone_brick_stairs": "Bloksjteinen traeje",
    "block.minecraft.stone_brick_wall": "Bloksjteinen moer",
    "block.minecraft.stone_bricks": "Bloksjteinen",
    "block.minecraft.stone_button": "Sjteine knop",
    "block.minecraft.stone_pressure_plate": "Sjteinen drukplaat",
    "block.minecraft.stone_slab": "Sjteinen plaat",
    "block.minecraft.stone_stairs": "Sjteinen trap",
    ...
    "block.minecraft.stripped_crimson_hyphae": "Gestripte karmozienroed schimmeldraod",
    "block.minecraft.stripped_crimson_stem": "Gestripte karmozienroed stem",
    ...
    "block.minecraft.tall_seagrass": "Hoog ziegraas",
    ...
    "block.minecraft.warped_stairs": "Spoekachtige houten trap",
    ...
    "block.minecraft.white_shulker_box": "Witte Shulker doeas",
    ...
    "block.minecraft.yellow_shulker_box": "Gaele Shulker doeas",
    ...
    "item.minecraft.cooked_chicken": "Gekaokde Hin",
    ...
    "item.minecraft.debug_stick.update": " nao %s",
    ...
    "item.minecraft.diamond_leggings": "Diamante beenstukken",
    ...
    "item.minecraft.firework_star.light_blue": "Licht Blauw",
    "item.minecraft.firework_star.light_gray": "Licht Gries",
    "item.minecraft.firework_star.lime": "Ligt Greun",
    ...
    "item.minecraft.firework_star.shape.large_ball": "Groeate bal",
    ...
    "item.minecraft.fishing_rod": "Gaert",
    ...
    "item.minecraft.glowstone_dust": "Gloeisjtein sjtóf",
    ...
    "item.minecraft.heart_of_the_sea": "Hart van de zie",
    ...
    "item.minecraft.leather_leggings": "Laere brook",
    "item.minecraft.light_blue_dye": "Licht blauwe kleurstof",
    "item.minecraft.light_gray_dye": "Licht grieze kleurstof",
    "item.minecraft.lime_dye": "Licht greun kleurstof",
    ...
    "item.minecraft.nether_brick": "Netherbaksjtein",
    ...
    "item.minecraft.pufferfish": "Kogelvèsj",
    "item.minecraft.pufferfish_bucket": "Tob mit kogelvis",
    "item.minecraft.pufferfish_spawn_egg": "Kogelvèsjespawnei",
    ...
    "item.minecraft.redstone": "Redstone sjtóf",
    ...
    "item.minecraft.shield.light_blue": "Licht blauw sjild",
    "item.minecraft.shield.light_gray": "Licht gries sjild",
    "item.minecraft.shield.lime": "Licht greun sjild",
    ...
    "item.minecraft.slime_spawn_egg": "Slijmkubesspawnei",
