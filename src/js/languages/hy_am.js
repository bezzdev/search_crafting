var items = {
    ...
    "block.minecraft.acacia_door": "Ակացիայի փայտից Դուռ",
    "block.minecraft.acacia_fence": "Ակացիայի ծառի փայտից Ցանկապատ",
    "block.minecraft.acacia_fence_gate": "Ակացիայի փայտից ցանկապատի դարպաս",
    "block.minecraft.acacia_leaves": "Ակացիայի տերևներ",
    ...
    "block.minecraft.acacia_sign": "Ակացիայի փայտից ցուցանակ",
    "block.minecraft.acacia_slab": "Ակացիայի սալիկ",
    "block.minecraft.acacia_stairs": "Ակացիայի փայտից աստիճաններ",
    ...
    "block.minecraft.banner.border.magenta": "Մագենտա Կապանք",
    ...
    "block.minecraft.banner.bricks.magenta": "Մագենտա դաշտը մասոնացված է",
    ...
    "block.minecraft.banner.curly_border.black": "Սև կապանք շեղված",
    "block.minecraft.banner.curly_border.blue": "Կապույտ կապանք շեղված",
    "block.minecraft.banner.curly_border.brown": "Շականակագույն կապանք շեղված",
    "block.minecraft.banner.curly_border.cyan": "Ցիան կապանք շեղված",
    "block.minecraft.banner.curly_border.gray": "Մոխրագույն կապանք շեղված",
    "block.minecraft.banner.curly_border.green": "Կանաչ կապանք շեղված",
    "block.minecraft.banner.curly_border.light_blue": "Բաց Կապույտ կապանք շեղված",
    "block.minecraft.banner.curly_border.light_gray": "Բաց Մոխրագույն կապանք շեղված",
    "block.minecraft.banner.curly_border.lime": "Բաց Կանաչ կապանք շեղված",
    "block.minecraft.banner.curly_border.magenta": "Մագենտա կապանք շեղված",
    "block.minecraft.banner.curly_border.orange": "Նարնջագույն կապանք շեղված",
    "block.minecraft.banner.curly_border.pink": "Վարդագույն կապանք շեղված",
    "block.minecraft.banner.curly_border.purple": "Մանուշակագույն կապանք շեղված",
    "block.minecraft.banner.curly_border.red": "Կարմիր կապանք շեղված",
    "block.minecraft.banner.curly_border.white": "Սպիտակ կապանք շեղված",
    "block.minecraft.banner.curly_border.yellow": "Դեղին կապանք շեղված",
    ...
    "block.minecraft.banner.diagonal_left.magenta": "Մագենտա  մեկ թեքում չարիք",
    ...
    "block.minecraft.banner.diagonal_right.magenta": "Մագենտա մեկ թեքում",
    ...
    "block.minecraft.banner.diagonal_up_left.black": "Սև մեկ թեքում հակադարձ ",
    ...
    "block.minecraft.banner.diagonal_up_left.orange": "Նարնջագույն մեկ թեքում հակադարձ",
    "block.minecraft.banner.diagonal_up_left.pink": "Վարդագույն մեկ թեքում հակադարձ",
    "block.minecraft.banner.diagonal_up_left.purple": "Մանուշակագույն մեկ թեքում հակադարձ",
    ...
    "block.minecraft.banner.flower.magenta": "Մագենտա ծաղիկների լիցքավորում",
    ...
    "block.minecraft.banner.globe.black": "Սեվ գլոբուս",
    "block.minecraft.banner.globe.blue": "Կապույտ գլոբուս",
    "block.minecraft.banner.globe.brown": "Շագանակագույն Գլոբուս",
    "block.minecraft.banner.globe.cyan": "Ջուրը Գլոբուսը",
    "block.minecraft.banner.globe.gray": "Մոխրագույն Գլոբուսը",
    "block.minecraft.banner.globe.green": "Կանաչ գլոբուս",
    "block.minecraft.banner.globe.light_blue": "Բաց կապույտ Գլոբուսը",
    "block.minecraft.banner.globe.light_gray": "Բաց մոխրագույն Գլոբուսը",
    "block.minecraft.banner.globe.lime": "Կրաքարի Գլոբուսը",
    "block.minecraft.banner.globe.magenta": "Մոխրագույն աշխարհը",
    "block.minecraft.banner.globe.orange": "Նարնջագույն աշխարհը",
    "block.minecraft.banner.globe.pink": "Վարդագույն Գլոբուսը",
    "block.minecraft.banner.globe.purple": "Մանուշակագույն Globe",
    "block.minecraft.banner.globe.red": "Կարմիր գլոբուս",
    "block.minecraft.banner.globe.white": "Սպիտակ Գլոբուսը",
    "block.minecraft.banner.globe.yellow": "Դեղին Գլոբուսը",
    "block.minecraft.banner.gradient.black": "Սև Գրադիենտ",
    "block.minecraft.banner.gradient.blue": "Կապույտ Գրադիենտ",
    "block.minecraft.banner.gradient.brown": "Շականակագույն Գրադիենտ",
    "block.minecraft.banner.gradient.cyan": "Ցիան Գրադիենտ",
    "block.minecraft.banner.gradient.gray": "Մոխրագույն Գրադիենտ",
    "block.minecraft.banner.gradient.green": "Կանաչ Գրադիենտ",
    "block.minecraft.banner.gradient.light_blue": "Բաց Կապույտ Գրադիենտ",
    "block.minecraft.banner.gradient.light_gray": "Բաց Մոխրագույն Գրադիենտ",
    "block.minecraft.banner.gradient.lime": "Բաց Կանաչ Գրադիենտ",
    "block.minecraft.banner.gradient.magenta": "Մագենտա Գրադիենտ",
    "block.minecraft.banner.gradient.orange": "Նարնջագույն Գրադիենտ",
    "block.minecraft.banner.gradient.pink": "Վարդագույն Գրադիենտ",
    "block.minecraft.banner.gradient.purple": "Մանուշակագույն Գրադիենտ",
    "block.minecraft.banner.gradient.red": "Կարմիր Գրադիենտ",
    "block.minecraft.banner.gradient.white": "Սպիտակ Գրադիենտ",
    "block.minecraft.banner.gradient.yellow": "Դեղին Գրադիենտ",
    "block.minecraft.banner.gradient_up.black": "Սև բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.blue": "Կապույտ բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.brown": "Շականակագույն բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.cyan": "Ցիան բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.gray": "Մոխրագույն բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.green": "Կանաչ բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.light_blue": "Բաց Կապույտ բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.light_gray": "Բաց Մոխրագույն բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.lime": "Բաց Կանաչ բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.magenta": "Մագենտա բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.orange": "Նարնջագույն բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.pink": "Վարդագույն բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.purple": "Մանուշակագույն բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.red": "Կարմիր բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.white": "Սպիտակ բազայի գրադիենտ",
    "block.minecraft.banner.gradient_up.yellow": "Դեղին բազայի գրադիենտ",
    ...
    "block.minecraft.banner.half_horizontal.magenta": "Մագենտա մեկ ճեղք",
    ...
    "block.minecraft.banner.half_horizontal_bottom.black": "Սև մեկ ճեղք հակադարձ ",
    "block.minecraft.banner.half_horizontal_bottom.blue": "Կապույտ մեկ ճեղք հակադարձ",
    "block.minecraft.banner.half_horizontal_bottom.brown": "Շականակագույն մեկ ճեղք հակադարձ",
    "block.minecraft.banner.half_horizontal_bottom.cyan": "Ցիան մեկ ճեղք հակադարձ",
    "block.minecraft.banner.half_horizontal_bottom.gray": "Մոխրագույն մեկ ճեղք հակադարձ",
    "block.minecraft.banner.half_horizontal_bottom.green": "Կանաչ մեկ ճեղք հակադարձ",
    "block.minecraft.banner.half_horizontal_bottom.light_blue": "Բաց Կապույտ մեկ ճեղքում Հակադարձ",
    "block.minecraft.banner.half_horizontal_bottom.light_gray": "Բաց Մոխրագույն մեկ ճեղք հակադարձ",
    ...
    "block.minecraft.banner.half_horizontal_bottom.pink": "Վարդագույն մեկ ճեղք հակադարձ",
    "block.minecraft.banner.half_horizontal_bottom.purple": "Մանուշակագույն մեկ ճեղք հակադարձ",
    "block.minecraft.banner.half_horizontal_bottom.red": "Կարմիր մեկ ճեղք հակադարձ",
    ...
    "block.minecraft.banner.half_vertical.magenta": "Մագենտա  մեկ գունատ",
    ...
    "block.minecraft.banner.half_vertical_right.magenta": "Մագենտա մեկ գունատ փոխարկված",
    ...
    "block.minecraft.banner.mojang.cyan": "Ցիան բան",
    ...
    "block.minecraft.banner.mojang.magenta": "Մագենտա բան",
    ...
    "block.minecraft.banner.skull.magenta": "Մագենտա գանգի լիցքավորում",
    ...
    "block.minecraft.banner.small_stripes.blue": "Կապույտ սյուներ",
    "block.minecraft.banner.small_stripes.brown": "Շագանակագույն սյուներ",
    "block.minecraft.banner.small_stripes.cyan": "Փիրուզագույն սյուներ",
    "block.minecraft.banner.small_stripes.gray": "Մոխրագույն սյուներ",
    "block.minecraft.banner.small_stripes.green": "Կանաչ սյուներ",
    "block.minecraft.banner.small_stripes.light_blue": "Բաց Կապույտ Մահճակալ",
    "block.minecraft.banner.small_stripes.light_gray": "Բաց մոխրագույն սյուներ",
    "block.minecraft.banner.small_stripes.lime": "Բաց կանաչ սյուներ",
    "block.minecraft.banner.small_stripes.magenta": "Մորեգույն հիմք",
    "block.minecraft.banner.small_stripes.orange": "Նարնջագույն սյուն",
    "block.minecraft.banner.small_stripes.pink": "Վարդագույն սյուներ",
    "block.minecraft.banner.small_stripes.purple": "Մանուշակագույն սյուներ",
    "block.minecraft.banner.small_stripes.red": "Կարմիր սյուներ",
    "block.minecraft.banner.small_stripes.white": "Սպիտակ Սյուն",
    "block.minecraft.banner.small_stripes.yellow": "Դեղին սյուներ",
    "block.minecraft.banner.square_bottom_left.black": "Ներքևի աջ սև խաչ",
    "block.minecraft.banner.square_bottom_left.blue": "Ներքևի աջ կապույտ խաչ",
    "block.minecraft.banner.square_bottom_left.brown": "Ներքևի աջ շագանակագույն խաչ",
    "block.minecraft.banner.square_bottom_left.cyan": "Ներքևի աջ փիրուզագույն խաչ",
    "block.minecraft.banner.square_bottom_left.gray": "Ներքևի աջ մոխրագույն խաչ",
    "block.minecraft.banner.square_bottom_left.green": "Ներքևի աջ կանաչ խաչ",
    "block.minecraft.banner.square_bottom_left.light_blue": "Ներքևի աջ բաց կապույտ խաչ",
    "block.minecraft.banner.square_bottom_left.light_gray": "Ներքևի աջ բաց մոխրագույն խաչ",
    "block.minecraft.banner.square_bottom_left.lime": "Ներքևի աջ բաց կանաչ խաչ",
    "block.minecraft.banner.square_bottom_left.magenta": "Ներքևի աջ մորեգույն խաչ",
    "block.minecraft.banner.square_bottom_left.orange": "Ներքևի աջ նարնջագույն խաչ",
    "block.minecraft.banner.square_bottom_left.pink": "Ներքևի աջ վարդագույն խաչ",
    "block.minecraft.banner.square_bottom_left.purple": "Ներքևի աջ մանուշակագույն խաչ",
    "block.minecraft.banner.square_bottom_left.red": "Ներքևի աջ կարմիր խաչ",
    "block.minecraft.banner.square_bottom_left.white": "Ներքևի աջ սպիտակ խաչ",
    "block.minecraft.banner.square_bottom_left.yellow": "Ներքևի աջ դեղին խաչ",
    "block.minecraft.banner.square_bottom_right.black": "Ներքևի ձախ սև խաչ",
    "block.minecraft.banner.square_bottom_right.blue": "Ներքևի ձախ կապույտ խաչ",
    "block.minecraft.banner.square_bottom_right.brown": "Ներքևի ձախ դարչնագույն խաչ",
    "block.minecraft.banner.square_bottom_right.cyan": "Ներքևի ձախ փիրուզագույն խաչ",
    "block.minecraft.banner.square_bottom_right.gray": "Ներքևի ձախ մոխրագույն խաչ",
    "block.minecraft.banner.square_bottom_right.green": "Ներքևի ձախ կանաչ խաչ",
    "block.minecraft.banner.square_bottom_right.light_blue": "Ներքևի ձախ բաց կապույտ խաչ",
    "block.minecraft.banner.square_bottom_right.light_gray": "Ներքևի ձախ բաց մոխրագույն խաչ",
    "block.minecraft.banner.square_bottom_right.lime": "Ներքևի ձախ բաց կանաչ խաչ",
    "block.minecraft.banner.square_bottom_right.magenta": "Ներքևի ձախ մորեգույն խաչ",
    "block.minecraft.banner.square_bottom_right.orange": "Ներքևի ձախ նարնջագույն խաչ",
    "block.minecraft.banner.square_bottom_right.pink": "Ներքևի ձախ վարդագույն խաչ",
    "block.minecraft.banner.square_bottom_right.purple": "Ներքևի ձախ մանուշակագույն խաչ",
    "block.minecraft.banner.square_bottom_right.red": "Ներքևի ձախ կարմիր խաչ",
    "block.minecraft.banner.square_bottom_right.white": "Ներքևի ձախ նարնջագույն խաչ",
    "block.minecraft.banner.square_bottom_right.yellow": "Ներքևի ձախ դեղին խաչ",
    "block.minecraft.banner.square_top_left.black": "Վերևի աջ սև խաչ",
    "block.minecraft.banner.square_top_left.blue": "Վերևի աջ կապույտ խաչ",
    "block.minecraft.banner.square_top_left.brown": "Վերևի աջ շագանակագույն խաչ",
    "block.minecraft.banner.square_top_left.cyan": "Վերևի աջ փիրուզագույն խաչ",
    "block.minecraft.banner.square_top_left.gray": "Վերևի աջ մոխրագույն խաչ",
    "block.minecraft.banner.square_top_left.green": "Վերև աջ կանաչ խաչ",
    "block.minecraft.banner.square_top_left.light_blue": "Վերևի աջ բաց կապույտ խաչ",
    "block.minecraft.banner.square_top_left.light_gray": "Վերևի աջ բաց մոխրագույն խաչ",
    "block.minecraft.banner.square_top_left.lime": "Վերևի աջ բաց կանաչ խաչ",
    "block.minecraft.banner.square_top_left.magenta": "Վերևի աջ մորեգույն խաչ",
    "block.minecraft.banner.square_top_left.orange": "Վերևի աջ նարնջագույն խաչ",
    "block.minecraft.banner.square_top_left.pink": "Վերև աջ վարդագույն խաչ",
    "block.minecraft.banner.square_top_left.purple": "Վերևի աջ մանուշակագույն խաչ",
    "block.minecraft.banner.square_top_left.red": "Վերև աջ կարմիր խաչ",
    "block.minecraft.banner.square_top_left.white": "Վերև աջ սպիտակ խաչ",
    "block.minecraft.banner.square_top_left.yellow": "Վերևի աջ դեղին խաչ",
    ...
    "block.minecraft.banner.straight_cross.blue": "Կապուտ Խաչ",
    "block.minecraft.banner.straight_cross.brown": "Դառչագույն Խաչ",
    ...
    "block.minecraft.banner.straight_cross.magenta": "Մագենտա խաչ",
    "block.minecraft.banner.straight_cross.orange": "Նարնջագույն խաչ",
    "block.minecraft.banner.straight_cross.pink": "Վառդագույն Խաչ",
    ...
    "block.minecraft.banner.stripe_left.lime": "Բաց կանաչ աջակողմյա սյուն",
    ...
    "block.minecraft.banner.stripe_right.lime": "Բաց կանաչ ձախակողմյա սյուն",
    ...
    "block.minecraft.banner.triangle_bottom.blue": "Կապույտ Շևրոն",
    "block.minecraft.banner.triangle_bottom.brown": "Շականակագույն Շևրոն",
    "block.minecraft.banner.triangle_bottom.cyan": "Ցիան Շևրոն",
    "block.minecraft.banner.triangle_bottom.gray": "Մոխրագույն Շևվրոն",
    "block.minecraft.banner.triangle_bottom.green": "Կանաչ Շևրոն",
    "block.minecraft.banner.triangle_bottom.light_blue": "Բաց Կապույտ Շևրոն",
    "block.minecraft.banner.triangle_bottom.light_gray": "Բաց Մոխրագույն Շևրոն",
    "block.minecraft.banner.triangle_bottom.lime": "Բաց Կանաչ Շևրոն",
    "block.minecraft.banner.triangle_bottom.magenta": "Մագնետա Շևրոն",
    "block.minecraft.banner.triangle_bottom.orange": "Նարնջագույն Շևրոն",
    "block.minecraft.banner.triangle_bottom.pink": "Վարդագույն Շևրոն",
    "block.minecraft.banner.triangle_bottom.purple": "Մանուշակագույն Շևրոն",
    "block.minecraft.banner.triangle_bottom.red": "Կարմիր Շևրոն",
    "block.minecraft.banner.triangle_bottom.white": "Սպիտակ Շևրոն",
    "block.minecraft.banner.triangle_bottom.yellow": "Դեղին Շևրոն",
    "block.minecraft.banner.triangle_top.black": "Սև Հակադարձ Շևրոն",
    ...
    "block.minecraft.banner.triangle_top.magenta": "Մագնետա Հակադարձ Շևրոն",
    ...
    "block.minecraft.banner.triangle_top.purple": "Մանուշակագույն Հակադարձ Շևրոն",
    "block.minecraft.banner.triangle_top.red": "Կարմիր Հակադարձ Շևրոն",
    "block.minecraft.banner.triangle_top.white": "Սպիտակ Հակադարձ Շևրոն",
    ...
    "block.minecraft.birch_door": "Կեչու փայտից դուռ",
    "block.minecraft.birch_fence": "Կեչու ծառի փայտից Ցանկապատ",
    "block.minecraft.birch_fence_gate": "Կեչու փայտից ցանկապատի դարպաս",
    "block.minecraft.birch_leaves": "Կեչու Տերևներ",
    ...
    "block.minecraft.birch_sign": "Կեչու փայտից ցուցանակ",
    "block.minecraft.birch_slab": "Կեչու սալիկ",
    "block.minecraft.birch_stairs": "Կեչու փայտից աստիճաններ",
    ...
    "block.minecraft.black_concrete_powder": "Սև չոր բետոն",
    ...
    "block.minecraft.blue_concrete_powder": "Կապույտ չոր բետոն",
    ...
    "block.minecraft.bone_block": "Ոսկրային կապան",
    "block.minecraft.bookshelf": "Գրադարակ",
    "block.minecraft.brain_coral": "Ուղեղային մարջան",
    "block.minecraft.brain_coral_block": "Ուղեղային մարջանի կապան",
    ...
    "block.minecraft.brown_concrete_powder": "Շագանակագույն չոր բետոն",
    "block.minecraft.brown_glazed_terracotta": "Դարչնագույն Թրծած Տեռակոտա",
    "block.minecraft.brown_mushroom": "Շագանակագույն Ճանճասպան",
    "block.minecraft.brown_mushroom_block": "Դարչնագույն Սնկի կապան",
    ...
    "block.minecraft.bubble_coral_block": "Պղպջակային մարջանի կապան",
    ...
    "block.minecraft.chain_command_block": "Շղթայած Հրամանների կապան",
    "block.minecraft.chest": "Սնդուկ",
    ...
    "block.minecraft.coal_block": "Ածուխի կապան",
    "block.minecraft.coal_ore": "Ածուխի Հանքաքար",
    "block.minecraft.coarse_dirt": "Կոշտ հող",
    ...
    "block.minecraft.command_block": "Հրամանների կապան",
    "block.minecraft.comparator": "Համեմատիչ",
    ...
    "block.minecraft.cyan_concrete_powder": "Փիրուզագույն չոր բետոն",
    ...
    "block.minecraft.cyan_stained_glass": "Փիրուզագույն Գունավոր Ապակի",
    ...
    "block.minecraft.dark_oak_fence": "Մուգ Կաղնու ծառի փայտից Ցանկապատ",
    "block.minecraft.dark_oak_fence_gate": "Մուգ Կաղնու փայտից ցանկապատի դարպաս",
    "block.minecraft.dark_oak_leaves": "Մուգ կաղնու տերևներ",
    "block.minecraft.dark_oak_log": "Մուգ կաղնե գերան",
    ...
    "block.minecraft.dark_oak_sign": "Մուգ կաղնու փայտից ցուցանակ",
    "block.minecraft.dark_oak_slab": "Մուգ կաղնու սալիկ",
    "block.minecraft.dark_oak_stairs": "Մուգ կաղնու փայտից աստիճաններ",
    ...
    "block.minecraft.dark_oak_wood": "Մուգ կաղնի",
    ...
    "block.minecraft.dead_brain_coral_block": "Մահացած ուղեղային մարջանի կապան",
    ...
    "block.minecraft.dead_bubble_coral_block": "Մահացած պղպջակային մարջանի կապան",
    ...
    "block.minecraft.dead_fire_coral_block": "Մահացած կրակոտ մարջանի կապան",
    ...
    "block.minecraft.dead_horn_coral_block": "Մահացած կոտոշային մարջանի կապան",
    ...
    "block.minecraft.dead_tube_coral_block": "Մահացած գլանային մարջանի կապան",
    ...
    "block.minecraft.diamond_block": "Ադամանդի կապան",
    ...
    "block.minecraft.dirt": "Հող",
    "block.minecraft.dispenser": "Վանիչ",
    "block.minecraft.dragon_egg": "Դրակոնի Ձու",
    "block.minecraft.dragon_head": "Վիշապի Գլուխ",
    "block.minecraft.dragon_wall_head": "Վիշապի գլուխ",
    "block.minecraft.dried_kelp_block": "Չորացրած լամինարիայի կապան",
    "block.minecraft.dropper": "Բաշխիչ",
    "block.minecraft.emerald_block": "Զմրուխտի կապան",
    ...
    "block.minecraft.ender_chest": "Էնդերի Արկղ",
    ...
    "block.minecraft.fire_coral_block": "Կրակոտ մարջանի կապան",
    ...
    "block.minecraft.gold_block": "Ոսկուց կապան",
    ...
    "block.minecraft.grass_block": "Խոտի կապան",
    ...
    "block.minecraft.green_concrete_powder": "Կանաչ չոր բետոն",
    ...
    "block.minecraft.honey_block": "Մեղրի կապան",
    "block.minecraft.honeycomb_block": "Մեղրամոմի կապան",
    "block.minecraft.hopper": "Ձագար",
    "block.minecraft.horn_coral": "Կոտոշավոր մարջան",
    "block.minecraft.horn_coral_block": "Կոտոշավոր մարջանի կապան",
    ...
    "block.minecraft.iron_block": "Երկաթի կապան",
    ...
    "block.minecraft.jungle_door": "Արևադարձային ծառի փայտից դուռ",
    "block.minecraft.jungle_fence": "Արևադարձային Ծառի Փայտից Ցանկապատ",
    "block.minecraft.jungle_fence_gate": "Արևադարձային ծառի փայտից ցանկապատի դարպաս",
    "block.minecraft.jungle_leaves": "Արևադարձային ծառի տերևներ",
    ...
    "block.minecraft.jungle_sign": "Արևադարձային ծառի փայտից ցուցանակ",
    "block.minecraft.jungle_slab": "Արևադարձային ծառի սալիկ",
    "block.minecraft.jungle_stairs": "Արևադարձային ծառի փայտից աստիճաններ",
    ...
    "block.minecraft.lapis_block": "Լաջվարդի կապան",
    "block.minecraft.lapis_ore": "Լազուրիտի Հանքաքար",
    ...
    "block.minecraft.light_blue_concrete_powder": "Բաց կապույտ չոր բետոն",
    ...
    "block.minecraft.light_blue_stained_glass": "Երկնագույն Ապակի",
    ...
    "block.minecraft.light_gray_concrete_powder": "Բաց մոխրագույն չոր բետոն",
    ...
    "block.minecraft.lime_banner": "Բաց Կանաչ Դրոշ",
    "block.minecraft.lime_bed": "Բաց Կանաչ Մահճակալ",
    "block.minecraft.lime_carpet": "Բաց Կանաչ Գորգ",
    "block.minecraft.lime_concrete": "Բաց Կանաչ Բետոն",
    "block.minecraft.lime_concrete_powder": "Բաց Կանաչ Չոր Բետոն",
    "block.minecraft.lime_glazed_terracotta": "Բաց Կանաչ Թրծած Տեռակոտա",
    "block.minecraft.lime_shulker_box": "Բաց Կանաչ Շալքերի Տուփ",
    "block.minecraft.lime_stained_glass": "Բաց Կանաչ Ապակի",
    "block.minecraft.lime_stained_glass_pane": "Բաց Կանաչ Ապակու Շերտ",
    ...
    "block.minecraft.magenta_bed": "Մորեգույն Մահճակալ",
    "block.minecraft.magenta_carpet": "Մորեգույն Գորգ",
    "block.minecraft.magenta_concrete": "Մորեգույն Բետոն",
    "block.minecraft.magenta_concrete_powder": "Մորեգույն չոր բետոն",
    ...
    "block.minecraft.magma_block": "Մագմայի կապան",
    ...
    "block.minecraft.nether_brick_fence": "Դժոխքային աղյուսե Ցանկապատ",
    "block.minecraft.nether_brick_slab": "Դժոխքային Աղյուսի Սալիկ",
    "block.minecraft.nether_brick_stairs": "Դժոխքային աղյուսե աստիճաններ",
    ...
    "block.minecraft.nether_portal": "Նեզերի պորտալ",
    ...
    "block.minecraft.nether_wart_block": "Նեզերի աճվածքի կապան",
    "block.minecraft.netherite_block": "Նեզերիտի կապան",
    "block.minecraft.netherrack": "Նեզերաքար",
    "block.minecraft.note_block": "Մեղեդու կապան",
    "block.minecraft.oak_button": "Կաղնու փայտից կոճակ",
    "block.minecraft.oak_door": "Կաղնե դուռ",
    "block.minecraft.oak_fence": "Կաղնու ծառի փայտից Ցանկապատ",
    "block.minecraft.oak_fence_gate": "Կաղնու դարպաս",
    "block.minecraft.oak_leaves": "Կաղնու Տերևներ",
    "block.minecraft.oak_log": "Կաղնե գերան",
    ...
    "block.minecraft.orange_concrete_powder": "Նարնջագույն չոր բետոն",
    ...
    "block.minecraft.pink_concrete_powder": "Վարդագույն չոր բետոն",
    ...
    "block.minecraft.polished_andesite": "Հարթեցված անդեզիտ",
    "block.minecraft.polished_andesite_slab": "Հարթեցված անդեզիտե սալիկ",
    "block.minecraft.polished_andesite_stairs": "Հարթեցված անդեզիտե աստիճաններ",
    ...
    "block.minecraft.polished_diorite": "Հարթեցված դիորիտ",
    ...
    "block.minecraft.polished_granite": "Հարթեցված գրանիտ",
    ...
    "block.minecraft.potted_dead_bush": "Ծաղկամանով չորացած թուփ",
    ...
    "block.minecraft.purple_concrete_powder": "Մանուշակագույն չոր բետոն",
    ...
    "block.minecraft.purple_stained_glass": "Մանուշակագույն Գունավոր Ապակի",
    ...
    "block.minecraft.purpur_block": "Պուրպուրե կապան",
    "block.minecraft.purpur_pillar": "Սյունաձև պուրպուրե կապան",
    ...
    "block.minecraft.red_concrete_powder": "Կարմիր չոր բետոն",
    "block.minecraft.red_glazed_terracotta": "Կարմիր Թրծած Տեռակոտա",
    "block.minecraft.red_mushroom": "Կարմիր սունկ",
    "block.minecraft.red_mushroom_block": "Կարմիր Ճանճասպանի կապան",
    "block.minecraft.red_nether_brick_slab": "Նեզերի կարմիր աղյուսե սալիկ",
    ...
    "block.minecraft.redstone_block": "Կարմրաքարի կապան",
    "block.minecraft.redstone_lamp": "Կարմրաքարի Լամպ",
    "block.minecraft.redstone_ore": "Կարմրաքարի Հանքաքար",
    "block.minecraft.redstone_torch": "Կարմրաքարե Ջահ",
    "block.minecraft.redstone_wall_torch": "Պատի կարմրաքարի ջահ",
    "block.minecraft.redstone_wire": "Կարմրափոշիի Լար",
    "block.minecraft.repeater": "Կրկնիչ",
    "block.minecraft.repeating_command_block": "Կրկնվող Հրամանների կապան",
    ...
    "block.minecraft.slime_block": "Լորձի կապան",
    "block.minecraft.smithing_table": "Դարբնի սեղան",
    "block.minecraft.smoker": "Ծխանոց",
    "block.minecraft.smooth_quartz": "Հարթ կվարցի կապան",
    ...
    "block.minecraft.snow_block": "Ձյան կապան",
    ...
    "block.minecraft.spawner": "Ստեղծող",
    "block.minecraft.sponge": "Սպունգ",
    "block.minecraft.spruce_button": "Եղևնու փայտից կոճակ",
    "block.minecraft.spruce_door": "Եղևնու փայտից դուռ",
    "block.minecraft.spruce_fence": "Եղևնու ծառի փայտից Ցանկապատ",
    "block.minecraft.spruce_fence_gate": "Եղևնու փայտից ցանկապատի դարպաս",
    "block.minecraft.spruce_leaves": "Եղևնու Տերևներ",
    ...
    "block.minecraft.spruce_sign": "Եղևնու փայտից ցուցանակ",
    "block.minecraft.spruce_slab": "Եղևնու սալիկ",
    "block.minecraft.spruce_stairs": "Եղևնու փայտից աստիճաններ",
    ...
    "block.minecraft.stripped_acacia_log": "Կեղևազրկած ակացիայի գերան",
    "block.minecraft.stripped_acacia_wood": "Տաշած ակացիայի փայտանյութ",
    "block.minecraft.stripped_birch_log": "Կեղևազրկած կեչու գերան",
    "block.minecraft.stripped_birch_wood": "Տաշած կեչու փայտանյութ",
    ...
    "block.minecraft.stripped_dark_oak_log": "Կեղևազրկած մուգ կաղնու գերան",
    "block.minecraft.stripped_dark_oak_wood": "Տաշած մուգ կաղնի",
    "block.minecraft.stripped_jungle_log": "Կեղևազրկած արևադարձային ծառի գերան",
    "block.minecraft.stripped_jungle_wood": "Տաշած արևադարձային ծառի փայտանյութ",
    "block.minecraft.stripped_oak_log": "Կեղևազրկած կաղնու գերան",
    "block.minecraft.stripped_oak_wood": "Տաշած կաղնի",
    "block.minecraft.stripped_spruce_log": "Կեղևազրկած եղևնու գերան",
    "block.minecraft.stripped_spruce_wood": "Տաշած եղևնու փայտանյութ",
    ...
    "block.minecraft.structure_block": "Կառուցվածքի կապան",
    "block.minecraft.structure_void": "Դատարկ կապան",
    ...
    "block.minecraft.warped_wart_block": "Աղավաղված Աճվածքի կապան",
    ...
    "block.minecraft.white_carpet": "Ճերմակ Գորգ",
    "block.minecraft.white_concrete": "Սպիտակ Բետոն",
    "block.minecraft.white_concrete_powder": "Սպիտակ չոր բետոն",
    ...
    "block.minecraft.white_wool": "Ճերմակ Բուրդ",
    ...
    "block.minecraft.yellow_concrete_powder": "Դեղին չոր բետոն",
    ...
    "item.minecraft.blaze_powder": "Բոցի Փոշի",
    "item.minecraft.blaze_rod": "Բոցի Ձող",
    ...
    "item.minecraft.cat_spawn_egg": "Կատու ստեղծելու ձու",
    "item.minecraft.cauldron": "Կաթսա",
    "item.minecraft.cave_spider_spawn_egg": "Քարանձավային սարդ ստեղծելու ձու",
    "item.minecraft.chainmail_boots": "Օղազրահե Կոշիկներ",
    "item.minecraft.chainmail_chestplate": "Օղազրահե Լանջապանակ",
    "item.minecraft.chainmail_helmet": "Օղազրահե Սաղավարտ",
    "item.minecraft.chainmail_leggings": "Օղազրահե Անդրավարտիք",
    "item.minecraft.charcoal": "Փայտացուխ",
    "item.minecraft.chest_minecart": "Վագոն Սնդուկով",
    "item.minecraft.chicken": "Հում Հավ",
    "item.minecraft.chicken_spawn_egg": "Հավ ստեղծելու ձու",
    ...
    "item.minecraft.cod_spawn_egg": "Ձողաձկան ստեղծելու ձու",
    ...
    "item.minecraft.cow_spawn_egg": "Կով ստեղծելու ձու",
    "item.minecraft.creeper_banner_pattern": "Դրոշի նմուշ",
    ...
    "item.minecraft.debug_stick.select": "ընտրված  (%s)",
    "item.minecraft.debug_stick.update": " ում %s",
    "item.minecraft.diamond": "Ադամանդ",
    "item.minecraft.diamond_axe": "Ադամանդե Կացին",
    "item.minecraft.diamond_boots": "Ադամանդե Կոշիկներ",
    "item.minecraft.diamond_chestplate": "Ադամանդե Շապիկ",
    ...
    "item.minecraft.dolphin_spawn_egg": "Դելֆին ստեղծելու ձու",
    "item.minecraft.donkey_spawn_egg": "Ավանակ ստեղծելու ձու",
    "item.minecraft.dragon_breath": "Վիշապի Շնչառաց",
    "item.minecraft.dried_kelp": "Ջրիմուռի չիր",
    "item.minecraft.drowned_spawn_egg": "Խորտակված ստեղծելու ձու",
    ...
    "item.minecraft.end_crystal": "Վերջի բյուրեղ",
    "item.minecraft.ender_eye": "Էնդերի Աչք",
    "item.minecraft.ender_pearl": "Էնդերի Մարգարիտ",
    "item.minecraft.enderman_spawn_egg": "Էնդերմեն ստեղծելու ձու",
    "item.minecraft.endermite_spawn_egg": "Էնդերմիտ ստեղծելու ձու",
    ...
    "item.minecraft.firework_star.lime": "Բաց Կանաչ",
    ...
    "item.minecraft.firework_star.shape.large_ball": "Խոշոր Գունդ",
    "item.minecraft.firework_star.shape.small_ball": "Փոքր Գունդ",
    ...
    "item.minecraft.flower_banner_pattern": "Դրոշի նմուշ",
    "item.minecraft.flower_banner_pattern.desc": "Ծաղիկ",
    "item.minecraft.flower_pot": "Ծաղկաման",
    "item.minecraft.fox_spawn_egg": "Աղվես ստեղծելու ձու",
    ...
    "item.minecraft.globe_banner_pattern": "Դրոշի նմուշ",
    "item.minecraft.globe_banner_pattern.desc": "Գլոբուս",
    ...
    "item.minecraft.golden_chestplate": "Ոսկե Շապիկ",
    ...
    "item.minecraft.iron_chestplate": "Երկաթե Լանջապանակ",
    ...
    "item.minecraft.leather_chestplate": "Կաշվե Լանջապանակ",
    ...
    "item.minecraft.lingering_potion": "Մառախուղի դեղաթույն",
    "item.minecraft.lingering_potion.effect.awkward": "Պղտոր եկարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.empty": "Անսարքելի երկարատեւ դեղ",
    "item.minecraft.lingering_potion.effect.fire_resistance": "Կրակի դիմադրության երկարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.harming": "Վնասի երկարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.healing": "Վերականգման երկարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.invisibility": "Անտեսանելիության երկարտև դեղորայք",
    "item.minecraft.lingering_potion.effect.leaping": "Ցատկոտության երկարտև դեղորայք",
    "item.minecraft.lingering_potion.effect.levitation": "Լեվիտացիայի երկարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.luck": "Բախտի երկարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.mundane": "Սովորական երկարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.night_vision": "Գիշերային տեսողության երկարատև թուրմ",
    "item.minecraft.lingering_potion.effect.poison": "Թույնի երարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.regeneration": "Ռեգեներացիայի երկարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.slow_falling": "Դանդաղ ընկնելու երկարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.slowness": "Դանդաղության երկարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.strength": "Ուժի երկարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.swiftness": "Ջրային շնչառության երկարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.thick": "Թավ երկարատև դեղորայք",
    ...
    "item.minecraft.lingering_potion.effect.water_breathing": "Ջրային շնչառության երկարատև դեղորայք",
    "item.minecraft.lingering_potion.effect.weakness": "Թուլության երկարատև դեղորայք",
    "item.minecraft.llama_spawn_egg": "Լամա ստեղծելու ձու",
    ...
    "item.minecraft.mojang_banner_pattern": "Դրոշի նմուշ",
    "item.minecraft.mojang_banner_pattern.desc": "Ինչ որ բան",
    "item.minecraft.mooshroom_spawn_egg": "Անասուունկը ստեղծելու ձու",
    "item.minecraft.mule_spawn_egg": "Մուլա ստեղծելու ձու",
    "item.minecraft.mushroom_stew": "Շոգեխաշած Սունկ",
    "item.minecraft.music_disc_11": "Երաժշտության Դիսկ",
    "item.minecraft.music_disc_11.desc": "C418 - 11",
    "item.minecraft.music_disc_13": "Երգի սկավառակ",
    "item.minecraft.music_disc_13.desc": "C418 - 13",
    "item.minecraft.music_disc_blocks": "Երգի սկավառակ",
    "item.minecraft.music_disc_blocks.desc": "C418 - blocks",
    "item.minecraft.music_disc_cat": "Երգի սկավառակ",
    "item.minecraft.music_disc_cat.desc": "C418 - cat",
    "item.minecraft.music_disc_chirp": "Երգի սկավառակ",
    "item.minecraft.music_disc_chirp.desc": "C418 - chirp",
    "item.minecraft.music_disc_far": "Երգի սկավառակ",
    "item.minecraft.music_disc_far.desc": "C418 - far",
    "item.minecraft.music_disc_mall": "Երգի սկավառակ",
    "item.minecraft.music_disc_mall.desc": "C418 - mall",
    "item.minecraft.music_disc_mellohi": "Երգի սկավառակ",
    "item.minecraft.music_disc_mellohi.desc": "C418 - mellohi",
    "item.minecraft.music_disc_pigstep": "Երգի սկավառակ",
    "item.minecraft.music_disc_pigstep.desc": "Լենա Ռեյն - Pigstep",
    "item.minecraft.music_disc_stal": "Երգի սկավառակ",
    "item.minecraft.music_disc_stal.desc": "C418 - stal",
    "item.minecraft.music_disc_strad": "Երգի սկավառակ",
    "item.minecraft.music_disc_strad.desc": "C418 - strad",
    "item.minecraft.music_disc_wait": "Երգի սկավառակ",
    "item.minecraft.music_disc_wait.desc": "C418 - wait",
    "item.minecraft.music_disc_ward": "Երաժշտության Դիսկ",
    ...
    "item.minecraft.netherite_chestplate": "Նեզերիտե Լանջապանակ",
    ...
    "item.minecraft.netherite_leggings": "Նեզերիտե անդրավարտիք",
    ...
    "item.minecraft.panda_spawn_egg": "Պանդա ստեղծելու ձու",
    "item.minecraft.paper": "Թուղթ",
    "item.minecraft.parrot_spawn_egg": "Թութակ ստեղծելու ձու",
    "item.minecraft.phantom_membrane": "Ֆանտոմի թաղանթ",
    "item.minecraft.phantom_spawn_egg": "Ֆանտոմ ստեղծելու ձու",
    "item.minecraft.pig_spawn_egg": "Խոզ ստեղծելու ձու",
    ...
    "item.minecraft.polar_bear_spawn_egg": "Սպիտակ արջ ստեղծելու ձու",
    ...
    "item.minecraft.potion.effect.harming": "Վնասակար Թուրմ",
    "item.minecraft.potion.effect.healing": "Բուժման Թուրմ",
    "item.minecraft.potion.effect.invisibility": "Անտեսանելիության դեղորայք",
    "item.minecraft.potion.effect.leaping": "Ցատկոտության դեղորայք",
    "item.minecraft.potion.effect.levitation": "Լեւիտացիայի խմորը",
    "item.minecraft.potion.effect.luck": "Հաջողություն Թուրմ",
    "item.minecraft.potion.effect.mundane": "Սովորական դեղորայք",
    "item.minecraft.potion.effect.night_vision": "Գիշերային տեսողության դեղորայք",
    "item.minecraft.potion.effect.poison": "Թունավորող Թուրմ",
    "item.minecraft.potion.effect.regeneration": "Վերածնում դեղ",
    "item.minecraft.potion.effect.slow_falling": "Դանդաղ ընկման դեղորայք",
    "item.minecraft.potion.effect.slowness": "Դանդաղության Թուրմ",
    "item.minecraft.potion.effect.strength": "Ուժի խմորը",
    "item.minecraft.potion.effect.swiftness": "Արագության թուրմ",
    "item.minecraft.potion.effect.thick": "Թավ թուրմ",
    "item.minecraft.potion.effect.turtle_master": "Կրիայի ուժի դեղորայք",
    "item.minecraft.potion.effect.water": "Ջրի շիշ",
    "item.minecraft.potion.effect.water_breathing": "Ջրային շնչառության խմորը",
    ...
    "item.minecraft.pufferfish_spawn_egg": "Փքաձուկ ստեղծելու ձու",
    ...
    "item.minecraft.rabbit_spawn_egg": "Ճագար ստեղծելու ձու",
    "item.minecraft.rabbit_stew": "Շոգեխաշած նապաստակ",
    "item.minecraft.ravager_spawn_egg": "Ավերիչ ստեղծելու ձու",
    ...
    "item.minecraft.salmon_spawn_egg": "Սաղմոն ստեղծելու ձու",
    "item.minecraft.scute": "Պատյան",
    "item.minecraft.shears": "Մկրատ",
    "item.minecraft.sheep_spawn_egg": "Ոչխար ստեղծելու ձու",
    ...
    "item.minecraft.shulker_spawn_egg": "Շալկեր ստեղծելու ձու",
    "item.minecraft.sign": "Ցուցանակ",
    "item.minecraft.silverfish_spawn_egg": "Արծաթաթեփուկ ստեղծելու ձու",
    "item.minecraft.skeleton_horse_spawn_egg": "Կմախք-ձի ստեղծելու ձու",
    "item.minecraft.skeleton_spawn_egg": "Կմախք ստեղծելու ձու",
    "item.minecraft.skull_banner_pattern": "Դրոշի նմուշ",
    "item.minecraft.skull_banner_pattern.desc": "Գանգ",
    "item.minecraft.slime_ball": "Լորձագնդակ",
    "item.minecraft.slime_spawn_egg": "Լորձ ստեղծելու ձու",
    "item.minecraft.snowball": "Ձնագնդիկ",
    "item.minecraft.spectral_arrow": "Սպեկտրալ Աղեղ",
    "item.minecraft.spider_eye": "Սարդի Աչք",
    "item.minecraft.spider_spawn_egg": "Սարդ ստեղծելու ձու",
    "item.minecraft.splash_potion": "Պայթուցիչ թեղաթույն",
    "item.minecraft.splash_potion.effect.awkward": "Պայթուցիկ պղտոր դեղորայք",
    "item.minecraft.splash_potion.effect.empty": "Պայթուցիկ անսարքելի դեղ",
    "item.minecraft.splash_potion.effect.fire_resistance": "Կրակի դիմադրության պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.harming": "Վնաս տալու պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.healing": "Վերականգնման պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.invisibility": "Անտեսանելիության պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.leaping": "Ցատկոտության պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.levitation": "Լեվիտացիայի պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.luck": "Բախտի պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.mundane": "Սովորական պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.night_vision": "Գիշերային տեսողության պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.poison": "Թույնի պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.regeneration": "Ռեգեներացիայի պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.slow_falling": "Դանդաղ ընկման պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.slowness": "Նետվող դանդաղության դեղ",
    "item.minecraft.splash_potion.effect.strength": "Ուժի պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.swiftness": "Արագության պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.thick": "Թավ պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.turtle_master": "Կրիայի հզորության պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.water": "Պայթուցիկ ջրի շիշ",
    "item.minecraft.splash_potion.effect.water_breathing": "Ջրային շնչառության պայթուցիկ դեղորայք",
    "item.minecraft.splash_potion.effect.weakness": "Թուլության պայթուցիկ դեղորայք",
    "item.minecraft.spruce_boat": "Եղևնու ծառից Նավակ",
    "item.minecraft.squid_spawn_egg": "Ութոտնուկ ստեղծելու ձու",
    ...
    "item.minecraft.strider_spawn_egg": "Լավաչափիկ ստեղծելու ձու",
    ...
    "item.minecraft.tipped_arrow.effect.luck": "Բախտի աղեղ",
    ...
    "item.minecraft.tnt_minecart": "Դինամիտով Վագոն",
    "item.minecraft.totem_of_undying": "Անմահության տոտեմ",
    "item.minecraft.trader_llama_spawn_egg": "Առևտրականի լամա ստեղծելու ձու",
    ...
    "item.minecraft.tropical_fish_spawn_egg": "Արևադարձային ձուկ ստեղծելու ձու",
    "item.minecraft.turtle_helmet": "Կրիայի պատյան",
    "item.minecraft.turtle_spawn_egg": "Կրիա ստեղծելու ձու",
